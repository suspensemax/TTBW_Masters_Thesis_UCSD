...
from aframe.core.aframe_try import Aframe
import numpy as np
import csdl
import m3l
...
class EBBeam(m3l.ExplicitOperation):
    def initialize(self, kwargs):
        ...
        self.parameters.declare('wing_strut_location', default=57)
        self.num_nodes = None
    ...
    def assign_attributes(self):
        ...
        self.wing_strut_location = self.parameters['wing_strut_location']
    ...
    def compute(self):
        ...
        csdl_model = LinearBeamCSDL(
            ...
            wing_strut_location=wing_strut_location,)
...
class LinearBeamCSDL(csdl.Model):
    def initialize(self):
        ...
        self.parameters.declare('wing_strut_location')
    ...
    def define(self):
        ...
        self.add(Aframe(beams=beams, bounds=bounds, joints=joints, mesh_units=mesh_units, wing_strut_location=wing_strut_location), name='Aframe')