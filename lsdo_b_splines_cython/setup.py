...
for name_list in list_of_pyx_names:
    ext_name = 'lsdo_b_splines_cython'
    source_name = 'lsdo_b_splines_cython'
    packages.append('{}.{}'.format('lsdo_b_splines_cython', name_list[0]))
