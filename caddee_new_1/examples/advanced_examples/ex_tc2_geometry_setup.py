...
left_point_am = wing.project(left_point, direction=np.array([0., 0., -0.99]))
...
wing_root_chord_le_am = wing.project(wing_root_chord_le, direction=np.array([0., 0., -1.]), plot=True)
wing_root_chord_te_am = wing.project(wing_root_chord_te, direction=np.array([0., 0., -1.]), plot=True)
