...
vertex01_left_strut = np.array([54.884, -15.209, -3.215]) # left leading 2
vertex02_left_strut = np.array([55.897, -21.628, -0.753]) # left leading 3
vertex03_left_strut = np.array([57.561, -25.480, 0.724]) # left leading 4
vertex04_left_strut = np.array([57.112, -29.331, 2.201]) # left leading 5
vertex05_left_strut = np.array([58.125, -35.750, 4.662]) # left leading 6
vertex06_left_strut = np.array([59.588, -38.318, 5.647]) # left leading 7

vertex10_left_strut = np.array([57.309, -12.641, -4.200]) # left trailing 1
vertex11_left_strut = np.array([58.809, -15.209, -3.215]) # left trailing 2
vertex12_left_strut = np.array([59.822, -21.628, -0.753]) # left trailing 3
vertex13_left_strut = np.array([59.373, -25.480, 0.724]) # left trailing 4
vertex14_left_strut = np.array([61.038, -29.331, 2.201]) # left trailing 5
vertex15_left_strut = np.array([62.051, -35.750, 4.662]) # left trailing 6                
vertex16_left_strut = np.array([61.399, -38.318, 5.647]) # left trailing 7
...
vertex01_right_strut = np.array([54.884, 15.209, -3.215]) # right leading 2
vertex02_right_strut = np.array([55.897, 21.628, -0.753]) # right leading 3
vertex03_right_strut = np.array([57.561, 25.480, 0.724]) # right leading 4
vertex04_right_strut = np.array([57.112, 29.331, 2.201]) # right leading 5
vertex05_right_strut = np.array([58.125, 35.750, 4.662]) # right leading 6
vertex06_right_strut = np.array([59.588, 38.318, 5.647]) # right leading 7

vertex10_right_strut = np.array([57.309, 12.641, -4.200]) # right trailing 1
vertex11_right_strut = np.array([58.809, 15.209, -3.215]) # right trailing 2
vertex12_right_strut = np.array([59.822, 21.628, -0.753]) # right trailing 3
vertex13_right_strut = np.array([59.373, 25.480, 0.724]) # right trailing 4
vertex14_right_strut = np.array([61.038, 29.331, 2.201]) # right trailing 5
vertex15_right_strut = np.array([62.051, 35.750, 4.662]) # right trailing 6                
vertex16_right_strut = np.array([61.399, 38.318, 5.647]) # right trailing 7
...
left_jury_le_left = np.array([58.029, -25.457, 0.682])
left_jury_le_right = np.array([57.410, -25.457, 5.721])
left_jury_te_left = np.array([58.985, -25.457, 0.682])
left_jury_te_right = np.array([58.595, -25.457, 5.721])
...
right_jury_le_left = np.array([58.029, 25.457, 0.682])
right_jury_le_right = np.array([57.410, 25.457, 5.721])
right_jury_te_left = np.array([58.985, 25.457, 0.682])
right_jury_te_right = np.array([58.595, 25.457, 5.721])
...
FFD_working_old_5 = True # span and chord 
...
if FFD_working_old_5: 
    ...
    # left -ve y
    wing_left_strut_connection_point = np.array([60.477, -38.303, 5.793])
    ...
    wing_right_strut_connection_point = np.array([60.477, 38.303, 5.793])
    ...
    # left
    wing_left_jury_connection_point = np.array([57.992, -25.457, 5.721])
    ...
    # right 
    wing_right_jury_connection_point = np.array([57.992, 25.457, 5.721])
    ...
    # left
    left_jury_left_strut_connection_point = np.array([58.498, -25.457, 0.682])
    ...
    #right
    right_jury_right_strut_connection_point = np.array([58.498, 25.457, 0.682])
...
#     wing_fuselage_connection_input = system_model.create_input(name='wing_fuselage_connection', shape=(3, ), val=wing_fuselage_connection_m3l.value)
    ...
    wing_sweep_angle = system_model.create_input(name='wing_sweep_angle', shape=(1,), val=np.deg2rad(12.17), dv_flag = geometry_dv, 
    ...
    left_strut_sweep_coefficients[np.array([0])] = (-1/2.2) * wing_sweep_coefficients[np.array([0])]
    ...
    right_strut_sweep_coefficients[np.array([1])] = (-1/2.2) *  wing_sweep_coefficients[np.array([2])]
