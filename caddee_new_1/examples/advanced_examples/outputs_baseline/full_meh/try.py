...
if components_plot:
    jury_left.plot()
jury_strut_left = geometry.declare_component(component_name='jury_strut_left', b_spline_search_names=['Jury, 1', 'Strut, 1'])
if components_plot:
    jury_strut_left.plot() 
jury_wing_left = geometry.declare_component(component_name='jury_wing_left', b_spline_search_names=['Jury, 1', 'Wing'])
if components_plot:
    jury_wing_left.plot() 
strut_wing_left = geometry.declare_component(component_name='strut_wing_left', b_spline_search_names=['Strut, 1', 'Wing'])
if components_plot:
    strut_wing_left.plot() 
...
wing_span_dv = system_model.create_input(name='wing_span_dv', shape = (1,), val = 172.5, dv_flag = geometry_dv, lower = 140., upper = 200., scaler= 1.e-1)
...
wing_tip_chord_left_dv = system_model.create_input(name='wing_tip_chord_left_dv', shape= (1,), val = 3.10, dv_flag = geometry_dv, lower=3.37, upper=4.13)
...
wing_root_chord_dv = system_model.create_input(name='wing_root_chord_dv', shape= (1,), val = 10.4, dv_flag = geometry_dv, lower=9.64, upper=11.79)
...
#     corner_43 = np.array([68.00, 85.50, 4.0])
    ...
    wing_ffd_block_sect_param.add_sectional_stretch(name='wing_chord_stretch', axis=2)

    wing_ffd_block_sect_param.add_sectional_rotation(name='wing_twist', axis=0)
    geometry_dv = True
    # geometry_dv = False
    ...
    wing_chord_stretch_coefficients = system_model.create_input(name= 'wing_chord_stretch_coefficients', shape=(5, ), val=np.array([10., 0., 0., 0., 10.]))
    ...
    wing_twist_coefficients = system_model.create_input(name='wing_twist_coefficients', shape= (3,), 
                                                        val=np.array([45, 0., 45]), dv_flag = geometry_dv, 
...
#     gearpod_chord_stretch = gearpod_chord_stretch_b_spline.evaluate(section_parametric_coordinates)
    ...
    tbw_param_solver.declare_state('wing_span_stretch_coefficients', wing_span_stretch_coefficients, penalty_factor=10)
...
#     wing_fuselage_connection_input = system_model.create_input(name='wing_fuselage_connection', shape=(3, ), val=wing_fuselage_connection_m3l.value)
    ...
    wing_ffd_block_sect_param.add_sectional_rotation(name='wing_twist', axis=2)
    geometry_dv = True
    # geometry_dv = False
