...
from examples.advanced_examples.outputs_baseline.tbw_geometry_1_trial_2 import (wing_meshes, htail_meshes, wing_span_dv, wing_root_chord_dv, 
...
if sizing_full:
    ...
    r_2_point_5g = system_model.create_input('range_2_point_5g', val=6482000) # in 'm' #3500 nautical miles #might have to change this
    ...
    # system_model.add_constraint(plus_2_point_5g_eb_beam_outputs_wing.displacements[0], lower=-2.0, upper=0.5) # baseline case
    ...
    if twist_geo_dv:
        ...
        # wing_ref_area = tbw_area_outputs_plus_1_point_0g.wing_area 
        # area_value = system_model.create_input('area_plus_1_point_0_g', val=wing_ref_area)
        wing_sweep_angle_plus_1_point_0g = system_model.create_input(name='wing_sweep_angle_plus_1_point_0g', shape=(1,), val=np.deg2rad(14.06),)
        chord_value = system_model.create_input('chord_plus_1_point_0g', val=wing_ref_chord)
        ...
        tbw_viscous_drag_outputs_plus_1_point_0g = tbw_viscous_drag_model_plus_1_point_0g.evaluate(atmos = atmos_1_point_0g, ac_states=ac_states_1_point_0g, 
                                                                                                ...
                                                                                                h_tail_area = h_tail_area, strut_area = strut_area, 
                                                                                                sweep_angle = wing_sweep_angle_plus_1_point_0g, mach_number = M_1_point_0g, angle_beta = angle_beta,) # tbw_viscous_drag_model_63_location_2
        # tbw_viscous_drag_outputs_plus_1_point_0g = tbw_viscous_drag_model_plus_1_point_0g.evaluate(atmos = atmos_1_point_0g, ac_states=ac_states_1_point_0g, 
        #                                                                                         tbw_area_outputs_plus_1_point_0g = tbw_area_outputs_plus_1_point_0g, chord = chord_value, vlm_outputs = vlm_outputs,)
        # tbw_viscous_drag_outputs = tbw_viscous_drag_model.evaluate(area = area_value, chord = chord_value)
        system_model.register_output(tbw_viscous_drag_outputs_plus_1_point_0g)
    ...
    system_model.add_objective(tbw_fuel_burn_outputs_plus_1_point_0g.fuel_burn, scaler = 1e-5)
    ...
    # sim = Simulator(caddee_csdl_model,name = 'tbw_range_baseline_trial_1', analytics=True)
    sim = Simulator(caddee_csdl_model,name = 'tbw_min_fuel_baseline_trial_1', analytics=True)
    ...
    # print('log_weight_ratio',sim['plus_1_point_0g_and_2_point_5g_and_minus_1_point_0g_tbw_range_model.log_weight_ratio'])
    # print('weight_ratio',sim['plus_1_point_0g_and_2_point_5g_and_minus_1_point_0g_tbw_range_model.weight_ratio'])
    ...
    # prob = CSDLProblem(problem_name='tbw_range_baseline_range_trial_1', simulator=sim)
    prob = CSDLProblem(problem_name='tbw_min_fuel_baseline_trial_11', simulator=sim)
...
#     print('Cf_viscous_1', sim['plus_1_point_0g_tbw_viscous_drag_model.Cf_viscous_1'])
   ...
   # Thicknesses
    ...
    print('fuel_burned', sim['plus_1_point_0g_and_2_point_5g_and_minus_1_point_0g_tbw_fuel_burn_model.fuel_burn_cruise_m3l'])
