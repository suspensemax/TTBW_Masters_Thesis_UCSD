...
if sizing_2_point_5g:
    ...
    tbw_range_plus_1_point_0g = Tbw_range_Model(
        name = 'tbw_range_final',
        counter = 'plus_1_point_0g_and_2_point_5g', 
    )
    # tbw_range_outputs_plus_1_point_0g = tbw_range_plus_1_point_0g.evaluate(L_over_D = tbw_L_over_D_outputs_plus_1_point_0g, total_mass_props = total_mass_props.mass, thrust = tbw_left_propulsion_outputs_plus_1_point_0g.thrust)
    # tbw_range_outputs_plus_1_point_0g = tbw_range_plus_1_point_0g.evaluate(L_over_D = tbw_L_over_D_outputs_plus_1_point_0g, total_mass_props = total_mass_props, thrust = tbw_left_propulsion_outputs_plus_1_point_0g)
    tbw_range_outputs_plus_1_point_0g = tbw_range_plus_1_point_0g.evaluate(L_over_D = tbw_L_over_D_outputs_plus_1_point_0g, wing_beam_mass_props = wing_beam_mass_props.mass, 
    ...
    sim.run()
    cd.print_caddee_outputs(system_model, sim, compact_print=True)
    print('total_fuel_burned',sim['plus_1_point_0g_and_2_point_5g_tbw_range_model.total_fuel_burned'])
    print('final_weight',sim['plus_1_point_0g_and_2_point_5g_tbw_range_model.final_weight'])
    print('range_cruise_m3l',sim['plus_1_point_0g_and_2_point_5g_tbw_range_model.range_cruise_m3l'])
    print('log_weight_ratio',sim['plus_1_point_0g_and_2_point_5g_tbw_range_model.log_weight_ratio'])
    print('weight_ratio',sim['plus_1_point_0g_and_2_point_5g_tbw_range_model.weight_ratio'])
    print('range_aaa',sim['plus_1_point_0g_and_2_point_5g_tbw_range_model.range_aaa'])
    # print(tbw_left_propulsion_outputs_plus_1_point_0g.thrust) 
    # exit()
...
if sizing_minus_1_point_0g:
    ...
    tbw_range_plus_1_point_0g = Tbw_range_Model(
        name = 'tbw_range_final',
        counter = 'plus_1_point_0g_and_minus_1_point_0g', 
    )
    # tbw_range_outputs_plus_1_point_0g = tbw_range_plus_1_point_0g.evaluate(L_over_D = tbw_L_over_D_outputs_plus_1_point_0g, total_mass_props = total_mass_props.mass, thrust = tbw_left_propulsion_outputs_plus_1_point_0g.thrust)
    # tbw_range_outputs_plus_1_point_0g = tbw_range_plus_1_point_0g.evaluate(L_over_D = tbw_L_over_D_outputs_plus_1_point_0g, total_mass_props = total_mass_props, thrust = tbw_left_propulsion_outputs_plus_1_point_0g)
    tbw_range_outputs_plus_1_point_0g = tbw_range_plus_1_point_0g.evaluate(L_over_D = tbw_L_over_D_outputs_plus_1_point_0g, wing_beam_mass_props = wing_beam_mass_props.mass, 
    ...
    sim = Simulator(caddee_csdl_model,name = 'who_knows_idk', analytics=True)
    sim['minus_1g_vlm_model.minus_1g_vlm_model.VLMSolverModel.VLM_outputs.LiftDrag.evaluation_pt'] = np.array([0., 0., 2.8])
    sim['plus_1g_vlm_model.plus_1g_vlm_model.VLMSolverModel.VLM_outputs.LiftDrag.evaluation_pt'] = np.array([0., 0., 2.8])
    ...
    sim.run()
    cd.print_caddee_outputs(system_model, sim, compact_print=True)
    print('total_fuel_burned',sim['plus_1_point_0g_and_minus_1_point_0g_tbw_range_model.total_fuel_burned'])
    print('final_weight',sim['plus_1_point_0g_and_minus_1_point_0g_tbw_range_model.final_weight'])
    print('range_cruise_m3l',sim['plus_1_point_0g_and_minus_1_point_0g_tbw_range_model.range_cruise_m3l'])
    print('log_weight_ratio',sim['plus_1_point_0g_and_minus_1_point_0g_tbw_range_model.log_weight_ratio'])
    print('weight_ratio',sim['plus_1_point_0g_and_minus_1_point_0g_tbw_range_model.weight_ratio'])
    print('range_aaa',sim['plus_1_point_0g_and_minus_1_point_0g_tbw_range_model.range_aaa'])
    # print(tbw_left_propulsion_outputs_plus_1_point_0g.thrust) 
    exit()

    prob = CSDLProblem(problem_name='who_knows_idk', simulator=sim)
