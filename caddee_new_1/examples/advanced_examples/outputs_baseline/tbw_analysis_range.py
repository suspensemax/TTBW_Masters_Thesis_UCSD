...
if sizing_2_point_5g:
    ...
    # system_model.add_constraint(plus_2_point_5g_eb_beam_outputs_wing.top_buckling[0], upper=1.0)
    ...
    prob = CSDLProblem(problem_name='full_range_2_point_5g', simulator=sim)
    optimizer = SLSQP(prob, maxiter=600, ftol=1E-5)
    optimizer.solve()
