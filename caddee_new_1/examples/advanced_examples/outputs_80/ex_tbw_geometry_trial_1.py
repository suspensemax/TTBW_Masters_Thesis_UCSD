...
if FFD_working_old_5: 
    ...
    # left -ve y
    wing_left_strut_connection_point = np.array([64.787, -68.640, 5.239])
    ...
    wing_right_strut_connection_point = np.array([64.787, 68.640, 5.239])
    ...
    # left
    wing_left_jury_connection_point = np.array([59.847, -40.666, 5.935])
    ...
    # right 
    wing_right_jury_connection_point = np.array([59.847, 40.666, 5.935])
    ...
    # left
    left_jury_left_strut_connection_point = np.array([60.611, -40.666, 0.486])
    ...
    #right
    right_jury_right_strut_connection_point = np.array([60.611, 40.666, 0.486])
...
#     wing_fuselage_connection_input = system_model.create_input(name='wing_fuselage_connection', shape=(3, ), val=wing_fuselage_connection_m3l.value)
    ...
    wing_sweep_angle = system_model.create_input(name='wing_sweep_angle', shape=(1,), val=np.deg2rad(10.00), dv_flag = geometry_dv, 
