...
from aframe import BeamMassModel
from aframe.core.beam_module_try import EBBeamForces, EBBeam
# from caddee.utils.helper_functions.geometry_helpers import  make_vlm_camber_mesh
import time 
import pickle
import pandas as pd

from examples.advanced_examples.outputs_80.tbw_geometry_sizing import (wing_meshes, htail_meshes, wing_span_dv, wing_root_chord_dv, 
...
wing_beam_t_top = system_model.create_input(name='wing_beam_ttop' ,val=wing_beam_ttop_metres_skin, dv_flag=sizing, lower=0.15 * inches_to_units, upper=0.7 * inches_to_units, scaler=10) # lower=0.00127 # skin thickness
wing_beam_t_bot = system_model.create_input(name='wing_beam_tbot' ,val=wing_beam_tbot_metres_skin, dv_flag=sizing, lower=0.15 * inches_to_units, upper=0.7 * inches_to_units, scaler=10)
wing_beam_tweb = system_model.create_input(name='wing_beam_tweb' ,val=wing_beam_tweb_metres, dv_flag=sizing, lower=0.15 * inches_to_units, upper=0.7 * inches_to_units, scaler=10)
...
left_strut_beam_t_top = system_model.create_input(name='left_strut_beam_ttop' ,val=strut_beam_metres_skin, dv_flag=sizing, lower=0.15 * inches_to_units, upper=0.5 * inches_to_units, scaler=10) # lower=0.00127
left_strut_beam_t_bot = system_model.create_input(name='left_strut_beam_tbot' ,val=strut_beam_metres_skin, dv_flag=sizing, lower=0.15 * inches_to_units, upper=0.5 * inches_to_units, scaler=10)
left_strut_beam_tweb = system_model.create_input(name='left_strut_beam_tweb' ,val=strut_beam_metres, dv_flag=sizing, lower=0.15 * inches_to_units, upper=0.5 * inches_to_units, scaler=10)

right_strut_beam_t_top = system_model.create_input(name='right_strut_beam_ttop' ,val=strut_beam_metres_skin, dv_flag=sizing, lower=0.15 * inches_to_units, upper=0.5 * inches_to_units, scaler=10) # lower=0.00127
right_strut_beam_t_bot = system_model.create_input(name='right_strut_beam_tbot' ,val=strut_beam_metres_skin, dv_flag=sizing, lower=0.15 * inches_to_units, upper=0.5 * inches_to_units, scaler=10)
right_strut_beam_tweb = system_model.create_input(name='right_strut_beam_tweb' ,val=strut_beam_metres, dv_flag=sizing, lower=0.15 * inches_to_units, upper=0.5 * inches_to_units, scaler=10)

jury_beam_metres = 0.15 * inches_to_units * np.ones((num_jury_beam, ))

left_jury_beam_t_top = system_model.create_input(name='left_jury_beam_ttop' ,val=jury_beam_metres, dv_flag=sizing, lower=0.12 * inches_to_units, upper=0.175 * inches_to_units, scaler=10) # lower=0.00127
left_jury_beam_t_bot = system_model.create_input(name='left_jury_beam_tbot' ,val=jury_beam_metres, dv_flag=sizing, lower=0.12 * inches_to_units, upper=0.175 * inches_to_units, scaler=10)
left_jury_beam_tweb = system_model.create_input(name='left_jury_beam_tweb' ,val=jury_beam_metres, dv_flag=sizing, lower=0.12 * inches_to_units, upper=0.175 * inches_to_units, scaler=10)
right_jury_beam_t_top = system_model.create_input(name='right_jury_beam_ttop' ,val=jury_beam_metres, dv_flag=sizing, lower=0.12 * inches_to_units, upper=0.175 * inches_to_units, scaler=10) # lower=0.00127
right_jury_beam_t_bot = system_model.create_input(name='right_jury_beam_tbot' ,val=jury_beam_metres, dv_flag=sizing, lower=0.12 * inches_to_units, upper=0.175 * inches_to_units, scaler=10)
right_jury_beam_tweb = system_model.create_input(name='right_jury_beam_tweb' ,val=jury_beam_metres, dv_flag=sizing, lower=0.12 * inches_to_units, upper=0.175 * inches_to_units, scaler=10)
...
if sizing_full:
    ...
    joints=joints,
    mesh_units='ft',
    wing_strut_location = counter_wing_strut,
    )
    ...
    sim = Simulator(caddee_csdl_model,name = f'just_sizing_outputs_outputs_{counter_wing_strut}_{counter}', analytics=True)
    ...
    exit()
    prob = CSDLProblem(problem_name=f'just_sizing_outputs_outputs_{counter_wing_strut}_{counter}', simulator=sim)
