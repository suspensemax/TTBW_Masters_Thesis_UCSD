...
left_strut_beam_t_top = system_model.create_input(name='left_strut_beam_ttop' ,val=strut_beam_metres_skin, dv_flag=sizing, lower=0.15 * inches_to_units, upper=0.5 * inches_to_units, scaler=1E3) # lower=0.00127
left_strut_beam_t_bot = system_model.create_input(name='left_strut_beam_tbot' ,val=strut_beam_metres_skin, dv_flag=sizing, lower=0.15 * inches_to_units, upper=0.5 * inches_to_units, scaler=1E3)
left_strut_beam_tweb = system_model.create_input(name='left_strut_beam_tweb' ,val=strut_beam_metres, dv_flag=sizing, lower=0.15 * inches_to_units, upper=0.5 * inches_to_units, scaler=1E3)

right_strut_beam_t_top = system_model.create_input(name='right_strut_beam_ttop' ,val=strut_beam_metres_skin, dv_flag=sizing, lower=0.15 * inches_to_units, upper=0.5 * inches_to_units, scaler=1E3) # lower=0.00127
right_strut_beam_t_bot = system_model.create_input(name='right_strut_beam_tbot' ,val=strut_beam_metres_skin, dv_flag=sizing, lower=0.15 * inches_to_units, upper=0.5 * inches_to_units, scaler=1E3)
right_strut_beam_tweb = system_model.create_input(name='right_strut_beam_tweb' ,val=strut_beam_metres, dv_flag=sizing, lower=0.15 * inches_to_units, upper=0.5 * inches_to_units, scaler=1E3)

jury_beam_metres = 0.15 * inches_to_units * np.ones((num_jury_beam, ))

left_jury_beam_t_top = system_model.create_input(name='left_jury_beam_ttop' ,val=jury_beam_metres, dv_flag=sizing, lower=0.12 * inches_to_units, upper=0.175 * inches_to_units, scaler=1E3) # lower=0.00127
left_jury_beam_t_bot = system_model.create_input(name='left_jury_beam_tbot' ,val=jury_beam_metres, dv_flag=sizing, lower=0.12 * inches_to_units, upper=0.175 * inches_to_units, scaler=1E3)
left_jury_beam_tweb = system_model.create_input(name='left_jury_beam_tweb' ,val=jury_beam_metres, dv_flag=sizing, lower=0.12 * inches_to_units, upper=0.175 * inches_to_units, scaler=1E3)
right_jury_beam_t_top = system_model.create_input(name='right_jury_beam_ttop' ,val=jury_beam_metres, dv_flag=sizing, lower=0.12 * inches_to_units, upper=0.175 * inches_to_units, scaler=1E3) # lower=0.00127
right_jury_beam_t_bot = system_model.create_input(name='right_jury_beam_tbot' ,val=jury_beam_metres, dv_flag=sizing, lower=0.12 * inches_to_units, upper=0.175 * inches_to_units, scaler=1E3)
right_jury_beam_tweb = system_model.create_input(name='right_jury_beam_tweb' ,val=jury_beam_metres, dv_flag=sizing, lower=0.12 * inches_to_units, upper=0.175 * inches_to_units, scaler=1E3)
...
if sizing_full:
    ...
    theta_2_point_5g = system_model.create_input('pitch_angle_2_point_5g', val=np.deg2rad(14.5), dv_flag=True, lower=np.deg2rad(-40), upper=np.deg2rad(40))
    ...
    sim = Simulator(caddee_csdl_model,name = 'just_sizing_outputs_{counter}', analytics=True)
    ...
    prob = CSDLProblem(problem_name='just_sizing_outputs_{counter}_optimization', simulator=sim)
