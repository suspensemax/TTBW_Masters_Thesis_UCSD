"Working - wing VLM --> wing structural full 80"
...
from examples.advanced_examples.outputs_80.ex_tbw_geometry_trial_2 import (wing_meshes, htail_meshes, wing_span_dv, wing_root_chord_dv, 
