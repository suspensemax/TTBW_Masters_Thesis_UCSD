...
from examples.advanced_examples.outputs_80.full_meh.tbw_geometry_trial_1 import (wing_meshes, htail_meshes, wing_span_dv, wing_root_chord_dv, 
...
fuel_calculation_combined = False
...
sim = Simulator(caddee_csdl_model,name = f'Mission_and_constraints_outputs_original_SLSPQ_Trial_{counter}', analytics=True)
...
prob = CSDLProblem(problem_name=f'Mission_and_constraints_outputs_original_SLSPQ_Trial_{counter}_optimization', simulator=sim)
