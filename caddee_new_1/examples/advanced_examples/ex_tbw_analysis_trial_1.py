"Working - wing VLM --> wing structural 1_point_0g(updated - has wing_meshes)"
...
#                                                                 left_strut_meshes, right_strut_meshes, 
#                                                                 left_jury_meshes, right_jury_meshes, 
#                                                                 vtail_meshes, S_ref, h_tail_area, v_tail_area, jury_area, strut_area,
#                                                                 drag_comp_list, wing_AR, system_model, 
#                                                                 wing_box_beam_mesh, left_strut_box_beam_mesh, right_strut_box_beam_mesh,
#                                                                 left_jury_box_beam_mesh, right_jury_box_beam_mesh, num_wing_beam,
#                                                                 num_strut_beam, num_jury_beam)
...
#                                                                 left_strut_meshes, right_strut_meshes, 
#                                                                 left_jury_meshes, right_jury_meshes, 
#                                                                 vtail_meshes, system_model, 
#                                                                 wing_box_beam_mesh, left_strut_box_beam_mesh, right_strut_box_beam_mesh,
#                                                                 left_jury_box_beam_mesh, right_jury_box_beam_mesh, num_wing_beam,
#                                                                 num_strut_beam, num_jury_beam)


from examples.advanced_examples.ex_tbw_geometry_setup_trial_1 import (wing_meshes, htail_meshes, wing_span_dv, wing_root_chord_dv, 
                                                                        wing_mid_chord_left_dv, wing_tip_chord_left_dv,   
                                                                left_strut_meshes, right_strut_meshes, 
                                                                left_jury_meshes, right_jury_meshes, 
                                                                vtail_meshes, S_ref, system_model, wing_AR, drag_comp_list, 
                                                                h_tail_area, jury_area, strut_area,
                                                                wing_box_beam_mesh, left_strut_box_beam_mesh, right_strut_box_beam_mesh,
                                                                left_jury_box_beam_mesh, right_jury_box_beam_mesh, num_wing_beam,
                                                                num_strut_beam, num_jury_beam)
...
density = 5350.  # SI - only wing mass - 5820
...
# wing_beam_ttop_metres_skin = wing_beam_ttop_inches_skin * inches_to_units
wing_beam_ttop_metres = wing_beam_ttop_inches_skin * inches_to_units
# wing_beam_ttop_metres = 0.5*np.ones(num_wing_beam) * inches_to_units

wing_beam_t_top = system_model.create_input(name='wing_beam_ttop' ,val=wing_beam_ttop_metres, dv_flag=sizing, lower=0.01 * inches_to_units, upper=0.875 * inches_to_units, scaler=10) # lower=0.00127
wing_beam_t_bot = system_model.create_input(name='wing_beam_tbot' ,val=wing_beam_ttop_metres, dv_flag=sizing, lower=0.01 * inches_to_units, upper=0.875 * inches_to_units, scaler=10)
wing_beam_tweb = system_model.create_input(name='wing_beam_tweb' ,val=wing_beam_ttop_metres, dv_flag=sizing, lower=0.0005 * inches_to_units, upper=0.875 * inches_to_units, scaler=10)
# wing_beam_tweb = system_model.create_input(name='wing_beam_tweb' ,val=wing_beam_ttop_metres_skin, dv_flag=sizing, lower=0.0005 * inches_to_units, upper=0.875 * inches_to_units, scaler=10)

# # left_beam_inches = np.ndarray([0.490, 0.425, 0.365, 0.330, 0.3125, 0.290, 0.270, 0.250, 0.230, 0.220]) #with constraint
strut_beam_inches_skin = np.array([0.490, 0.425, 0.365, 0.330, 0.290, 0.3125, 0.345, 0.390, 0.425]) # w/o constraint
# 0.220, 0.230, 0.250, 0.270, 0.290, 0.3125, 0.330, 0.365, 0.425,
# strut_beam_metres_skin = strut_beam_inches_skin * inches_to_units
strut_beam_metres = strut_beam_inches_skin * inches_to_units

# strut_beam_inches = 0.5*np.ones(num_strut_beam)
# strut_beam_metres = strut_beam_inches * inches_to_units

left_strut_beam_t_top = system_model.create_input(name='left_strut_beam_ttop' ,val=strut_beam_metres, dv_flag=sizing, lower=0.15 * inches_to_units, upper=0.625 * inches_to_units, scaler=10) # lower=0.00127
left_strut_beam_t_bot = system_model.create_input(name='left_strut_beam_tbot' ,val=strut_beam_metres, dv_flag=sizing, lower=0.15 * inches_to_units, upper=0.625 * inches_to_units, scaler=10)
left_strut_beam_tweb = system_model.create_input(name='left_strut_beam_tweb' ,val=strut_beam_metres, dv_flag=sizing, lower=0.01 * inches_to_units, upper=0.625 * inches_to_units, scaler=10)
# left_strut_beam_tweb = system_model.create_input(name='left_strut_beam_tweb' ,val=strut_beam_metres_skin, dv_flag=sizing, lower=0.01 * inches_to_units, upper=0.625 * inches_to_units, scaler=1E3)

right_strut_beam_t_top = system_model.create_input(name='right_strut_beam_ttop' ,val=strut_beam_metres, dv_flag=sizing, lower=0.15 * inches_to_units, upper=0.625 * inches_to_units, scaler=10) # lower=0.00127
right_strut_beam_t_bot = system_model.create_input(name='right_strut_beam_tbot' ,val=strut_beam_metres, dv_flag=sizing, lower=0.15 * inches_to_units, upper=0.625 * inches_to_units, scaler=10)
right_strut_beam_tweb = system_model.create_input(name='right_strut_beam_tweb' ,val=strut_beam_metres, dv_flag=sizing, lower=0.01 * inches_to_units, upper=0.625 * inches_to_units, scaler=10)
# right_strut_beam_tweb = system_model.create_input(name='right_strut_beam_tweb' ,val=strut_beam_metres_skin, dv_flag=sizing, lower=0.01 * inches_to_units, upper=0.625 * inches_to_units, scaler=1E3)

jury_beam_metres = 0.15 * inches_to_units * np.ones((num_jury_beam, ))
left_jury_beam_t_top = system_model.create_input(name='left_jury_beam_ttop' ,val=jury_beam_metres, dv_flag=sizing, lower=0.01 * inches_to_units, upper=0.250 * inches_to_units, scaler=10) # lower=0.00127
left_jury_beam_t_bot = system_model.create_input(name='left_jury_beam_tbot' ,val=jury_beam_metres, dv_flag=sizing, lower=0.01 * inches_to_units, upper=0.250 * inches_to_units, scaler=10)
left_jury_beam_tweb = system_model.create_input(name='left_jury_beam_tweb' ,val=jury_beam_metres, dv_flag=sizing, lower=0.001 * inches_to_units, upper=0.250 * inches_to_units, scaler=10)
right_jury_beam_t_top = system_model.create_input(name='right_jury_beam_ttop' ,val=jury_beam_metres, dv_flag=sizing, lower=0.01 * inches_to_units, upper=0.250 * inches_to_units, scaler=10) # lower=0.00127
right_jury_beam_t_bot = system_model.create_input(name='right_jury_beam_tbot' ,val=jury_beam_metres, dv_flag=sizing, lower=0.01 * inches_to_units, upper=0.250 * inches_to_units, scaler=10)
right_jury_beam_tweb = system_model.create_input(name='right_jury_beam_tweb' ,val=jury_beam_metres, dv_flag=sizing, lower=0.001 * inches_to_units, upper=0.250 * inches_to_units, scaler=10)

# wing_beam_t_top = system_model.create_input(name='wing_beam_ttop' ,val=wing_beam_ttop_metres, dv_flag=sizing, lower=0.05 * inches_to_units, upper=0.875 * inches_to_units, scaler=1E3) # lower=0.00127
# wing_beam_t_bot = system_model.create_input(name='wing_beam_tbot' ,val=wing_beam_ttop_metres, dv_flag=sizing, lower=0.05 * inches_to_units, upper=0.875 * inches_to_units, scaler=1E3)
# wing_beam_tweb = system_model.create_input(name='wing_beam_tweb' ,val=wing_beam_ttop_metres_skin, dv_flag=sizing, lower=0.05 * inches_to_units, upper=0.875 * inches_to_units, scaler=1E3)

# left_strut_beam_t_top = system_model.create_input(name='left_strut_beam_ttop' ,val=strut_beam_metres, dv_flag=sizing, lower=0.15 * inches_to_units, upper=0.625 * inches_to_units, scaler=1E3) # lower=0.00127
# left_strut_beam_t_bot = system_model.create_input(name='left_strut_beam_tbot' ,val=strut_beam_metres, dv_flag=sizing, lower=0.15 * inches_to_units, upper=0.625 * inches_to_units, scaler=1E3)
# left_strut_beam_tweb = system_model.create_input(name='left_strut_beam_tweb' ,val=strut_beam_metres, dv_flag=sizing, lower=0.01 * inches_to_units, upper=0.625 * inches_to_units, scaler=1E3)
# # left_strut_beam_tweb = system_model.create_input(name='left_strut_beam_tweb' ,val=strut_beam_metres_skin, dv_flag=sizing, lower=0.01 * inches_to_units, upper=0.625 * inches_to_units, scaler=1E3)

# right_strut_beam_t_top = system_model.create_input(name='right_strut_beam_ttop' ,val=strut_beam_metres, dv_flag=sizing, lower=0.15 * inches_to_units, upper=0.625 * inches_to_units, scaler=1E3) # lower=0.00127
# right_strut_beam_t_bot = system_model.create_input(name='right_strut_beam_tbot' ,val=strut_beam_metres, dv_flag=sizing, lower=0.15 * inches_to_units, upper=0.625 * inches_to_units, scaler=1E3)
# right_strut_beam_tweb = system_model.create_input(name='right_strut_beam_tweb' ,val=strut_beam_metres, dv_flag=sizing, lower=0.01 * inches_to_units, upper=0.625 * inches_to_units, scaler=1E3)
# # right_strut_beam_tweb = system_model.create_input(name='right_strut_beam_tweb' ,val=strut_beam_metres_skin, dv_flag=sizing, lower=0.01 * inches_to_units, upper=0.625 * inches_to_units, scaler=1E3)

# jury_beam_metres = 0.15 * inches_to_units * np.ones((num_jury_beam, ))
# left_jury_beam_t_top = system_model.create_input(name='left_jury_beam_ttop' ,val=jury_beam_metres, dv_flag=sizing, lower=0.01 * inches_to_units, upper=0.250 * inches_to_units, scaler=1E3) # lower=0.00127
# left_jury_beam_t_bot = system_model.create_input(name='left_jury_beam_tbot' ,val=jury_beam_metres, dv_flag=sizing, lower=0.01 * inches_to_units, upper=0.250 * inches_to_units, scaler=1E3)
# left_jury_beam_tweb = system_model.create_input(name='left_jury_beam_tweb' ,val=jury_beam_metres, dv_flag=sizing, lower=0.001 * inches_to_units, upper=0.250 * inches_to_units, scaler=1E3)
# right_jury_beam_t_top = system_model.create_input(name='right_jury_beam_ttop' ,val=jury_beam_metres, dv_flag=sizing, lower=0.01 * inches_to_units, upper=0.250 * inches_to_units, scaler=1E3) # lower=0.00127
# right_jury_beam_t_bot = system_model.create_input(name='right_jury_beam_tbot' ,val=jury_beam_metres, dv_flag=sizing, lower=0.01 * inches_to_units, upper=0.250 * inches_to_units, scaler=1E3)
# right_jury_beam_tweb = system_model.create_input(name='right_jury_beam_tweb' ,val=jury_beam_metres, dv_flag=sizing, lower=0.001 * inches_to_units, upper=0.250 * inches_to_units, scaler=1E3)
...
if load_factor_1_point_0g:
    ...
    tbw_viscous_drag_outputs_plus_1_point_0g = tbw_viscous_drag_model_plus_1_point_0g.evaluate(atmos = atmos_1_point_0g, ac_states=ac_states_1_point_0g, 
                                                                                            tbw_area_outputs_plus_1_point_0g = tbw_area_outputs_plus_1_point_0g, chord = chord_value, vlm_outputs = vlm_outputs_plus_1_point_0g)
    ...
    sim = Simulator(caddee_csdl_model,name = 'Forward_tbw_with_beam_trim_baseline_1g', analytics=True)
    ...
    print('beam inertia tensor', sim['beam_mass_model.inertia_tensor'])
    print('beam cg vector', sim['beam_mass_model.cg_vector'])
    print('tbw_cg', sim['TBW_Mass_Properties.cg_vector'])
    print('total cg_vector', sim['total_mass_properties_model_tbw.total_cg_vector'])
    print('tbw mass', sim['TBW_Mass_Properties.mass'])
    print('beam mass', sim['beam_mass_model.mass'])
    print('total mass', sim['total_mass_properties_model_tbw.total_mass'])
...
if sizing:
    ...
    # oml_forces = vlm_force_mapping_model.evaluate(vlm_forces=vlm_outputs_2_point_5g.panel_forces, nodal_force_meshes=[wing_meshes.oml_mesh, htail_meshes.oml_mesh, right_strut_meshes.oml_mesh, left_strut_meshes.oml_mesh]) 
    oml_forces = vlm_force_mapping_model.evaluate(vlm_forces=vlm_outputs_2_point_5g.panel_forces, nodal_force_meshes=[wing_meshes.oml_mesh,htail_meshes.oml_mesh])
    ...
    number_fixed = 3
    left_strut_oml_forces = m3l.Variable(name = 'left_strut_mesh_forces', shape=(num_strut_beam,number_fixed), value = np.zeros(((num_strut_beam,number_fixed))))
    right_strut_oml_forces = m3l.Variable(name = 'right_strut_mesh_forces', shape=(num_strut_beam,number_fixed), value = np.zeros(((num_strut_beam,number_fixed))))
    left_jury_oml_forces = m3l.Variable(name = 'left_jury_mesh_forces', shape=(num_jury_beam,number_fixed), value = np.zeros(((num_jury_beam,number_fixed))))
    right_jury_oml_forces = m3l.Variable(name = 'right_jury_mesh_forces', shape=(num_jury_beam,number_fixed), value = np.zeros(((num_jury_beam,number_fixed))))
    ...
    plus_2_point_5g_eb_beam_outputs_wing = beam_displacement_model.evaluate(beam_nodes=[wing_box_beam_mesh.beam_nodes, left_strut_box_beam_mesh.beam_nodes, right_strut_box_beam_mesh.beam_nodes, left_jury_box_beam_mesh.beam_nodes, right_jury_box_beam_mesh.beam_nodes],
                                    ...
                                    t_bot=[wing_beam_t_bot, left_strut_beam_t_bot, right_strut_beam_t_bot, left_jury_beam_t_bot, right_jury_beam_t_bot],
                                    t_web=[wing_beam_tweb, left_strut_beam_tweb, right_strut_beam_tweb, left_jury_beam_tweb, right_jury_beam_tweb], 
                                    forces = [structural_wing_mesh_forces_2_point_5g,left_strut_oml_forces,right_strut_oml_forces,left_jury_oml_forces, right_jury_oml_forces])
    ...
    # # system_model.add_constraint(plus_2_point_5g_eb_beam_outputs_wing.displacements, lower=-0.5, upper=0.5)
    # # system_model.add_constraint(plus_2_point_5g_eb_beam_outputs_wing.stresses, upper=350E6/1., scaler=0.5e-8)
    system_model.add_constraint(plus_2_point_5g_eb_beam_outputs_wing.stresses[0], upper=620E6/1., scaler=1e-8) #90,000 PSI 
    ...
    # system_model.add_objective(plus_2_point_5g_trim_variables.accelerations, scaler=1e-3)
    # system_model.add_objective(tbw_L_over_D_outputs_plus_2_point_5g.L_over_D, scaler = -1)
    # system_model.add_constraint(tbw_L_over_D_outputs_plus_2_point_5g.L_over_D, scaler = -1)
    ...
    # oml_forces = vlm_force_mapping_model.evaluate(vlm_forces=vlm_outputs_minus_1_point_0g.panel_forces, nodal_force_meshes=[wing_meshes.oml_mesh])
    ...
    # structural_wing_mesh_forces_1_point_0g = beam_force_map_model.evaluate(
    # beam_mesh=wing_box_beam_mesh.beam_nodes,
    # nodal_forces=wing_oml_forces,
    # nodal_forces_mesh=wing_meshes.oml_mesh
    # )
    ...
    # # system_model.add_constraint(minus_1_point_0g_eb_beam_outputs_wing.bot_buckling, upper=1)
...
if sizing_only_wing:
    ...
    r_2_point_5g = system_model.create_input('range_2_point_5g', val=6482000) # in 'm'
    theta_2_point_5g = system_model.create_input('pitch_angle_2_point_5g', val=np.deg2rad(14.5), dv_flag=True, lower=np.deg2rad(0), upper=np.deg2rad(50))
    ...
    # wing_oml_forces = oml_forces.panel_forces[0]
    wing_oml_forces = oml_forces[0]
    # htail_oml_forces = oml_forces[1]
    # right_strut_oml_forces = oml_forces[2]
    # left_strut_oml_forces = oml_forces[3]
    ...
    # print(wing_oml_forces)
    # # print(structural_wing_mesh_forces_2_point_5g.shape)
    # exit()
    number_fixed = 3
    left_strut_oml_forces = m3l.Variable(name = 'left_strut_mesh_forces', shape=(num_strut_beam,number_fixed), value = np.zeros(((num_strut_beam,number_fixed))))
    right_strut_oml_forces = m3l.Variable(name = 'right_strut_mesh_forces', shape=(num_strut_beam,number_fixed), value = np.zeros(((num_strut_beam,number_fixed))))
    ...
    plus_2_point_5g_eb_beam_outputs_wing = beam_displacement_model.evaluate(beam_nodes=[wing_box_beam_mesh.beam_nodes, left_strut_box_beam_mesh.beam_nodes, right_strut_box_beam_mesh.beam_nodes, left_jury_box_beam_mesh.beam_nodes, right_jury_box_beam_mesh.beam_nodes],
                                    ...
                                    t_top=[wing_beam_t_top, left_strut_beam_t_top, right_strut_beam_t_top, left_jury_beam_t_top, right_jury_beam_t_top],
                                    t_bot=[wing_beam_t_bot, left_strut_beam_t_bot, right_strut_beam_t_bot, left_jury_beam_t_bot, right_jury_beam_t_bot],
                                    t_web=[wing_beam_tweb, left_strut_beam_tweb, right_strut_beam_tweb, left_jury_beam_tweb, right_jury_beam_tweb], forces = [structural_wing_mesh_forces_2_point_5g,left_strut_oml_forces,right_strut_oml_forces,left_jury_oml_forces, right_jury_oml_forces])
...
sizing_wing_strut_jury_together = False 

if sizing_wing_strut_jury_together:
    ...
    # system_model.add_objective(tbw_L_over_D_outputs_plus_2_point_5g.L_over_D, scaler = -1)
    # system_model.add_constraint(tbw_L_over_D_outputs_plus_2_point_5g.L_over_D, scaler = -1)
    # system_model.add_objective(wing_beam_mass_props.mass, scaler = 1e-5)
...
sizing_wing_strut_jury_individual = True 

if sizing_wing_strut_jury_individual:
    sizing_2_point_5g = True
    if sizing_2_point_5g:
        ...
        # system_model.add_constraint(plus_1_point_0g_eb_beam_outputs.bot_buckling, upper=1)
        # system_model.add_constraint(plus_2_point_5g_eb_beam_outputs_wing.top_buckling[0], upper=1100)
        # system_model.add_constraint(plus_2_point_5g_eb_beam_outputs_wing.displacements[0], lower=-1.0, upper=1.0)
        ...
        sim = Simulator(caddee_csdl_model,name = 'beam_Save_outputs_2_point_5g', analytics=True)
        sim['plus_2_point_5g_vlm_model.plus_2_point_5g_vlm_model.VLMSolverModel.VLM_outputs.LiftDrag.evaluation_pt'] = np.array([0., 0., 2.8])
        ...
        # endregion
        exit()
        prob = CSDLProblem(problem_name='beam_tbw_2_point_5g', simulator=sim)
        ...
        nodal_sol_df_wing_2_point_5g.to_excel(f'Sol_dict_2_point_5g_wing_wing_strut_jury_{np.rad2deg(theta_2_point_5g.value)}deg.xlsx')
        #print(nodal_sol_df_wing)
        nodal_sol_df_wing_1_2_point_5g = pd.DataFrame(data=sol_dict_wing_1_2_point_5g)
        nodal_sol_df_wing_1_2_point_5g.to_excel(f'sol_dict_2_point_5g_wing_1_wing_strut_jury_{np.rad2deg(theta_2_point_5g.value)}deg.xlsx')   
        #print(nodal_sol_df_wing_1)  
        nodal_sol_df_wing_2_2_point_5g = pd.DataFrame(data=sol_dict_wing_2_2_point_5g)
        nodal_sol_df_wing_2_2_point_5g.to_excel(f'sol_dict_2_point_5g_wing_2_wing_strut_jury_{np.rad2deg(theta_2_point_5g.value)}deg.xlsx') 
        nodal_sol_df_wing_3_2_point_5g = pd.DataFrame(data=sol_dict_wing_3_2_point_5g)
        nodal_sol_df_wing_3_2_point_5g.to_excel(f'sol_dict_2_point_5g_wing_3_wing_strut_jury_{np.rad2deg(theta_2_point_5g.value)}deg.xlsx') 
        nodal_sol_df_wing_4_2_point_5g = pd.DataFrame(data=sol_dict_wing_4_2_point_5g)
        nodal_sol_df_wing_4_2_point_5g.to_excel(f'sol_dict_2_point_5g_wing_4_wing_strut_jury_{np.rad2deg(theta_2_point_5g.value)}deg.xlsx') 
        # endregion


    sizing_minus_1_point_0g = False
    if sizing_minus_1_point_0g:
        ...
        sim = Simulator(caddee_csdl_model,name = 'beam_Save_outputs_minus_1_point_0g', analytics=True)
        ...
        prob = CSDLProblem(problem_name='beam_tbw_minus_1_point_0g', simulator=sim)
        optimizer = SLSQP(prob, maxiter=200, ftol=1E-5)
        optimizer.solve()
        optimizer.print_results()
        ...
        nodal_sol_df_wing_minus_1_point_0g.to_excel(f'Sol_dict_minus_1_point_0g_wing_wing_strut_jury_{np.rad2deg(theta_minus_1_point_0_g.value)}deg.xlsx')
        #print(nodal_sol_df_wing)
        nodal_sol_df_wing_1_minus_1_point_0g = pd.DataFrame(data=sol_dict_wing_1_minus_1_point_0g)
        nodal_sol_df_wing_1_minus_1_point_0g.to_excel(f'sol_dict_minus_1_point_0g_wing_1_wing_strut_jury_{np.rad2deg(theta_minus_1_point_0_g.value)}deg.xlsx')   
        #print(nodal_sol_df_wing_1)  
        nodal_sol_df_wing_2_minus_1_point_0g = pd.DataFrame(data=sol_dict_wing_2_minus_1_point_0g)
        nodal_sol_df_wing_2_minus_1_point_0g.to_excel(f'sol_dict_minus_1_point_0g_wing_2_wing_strut_jury_{np.rad2deg(theta_minus_1_point_0_g.value)}deg.xlsx') 
        nodal_sol_df_wing_3_minus_1_point_0g = pd.DataFrame(data=sol_dict_wing_3_minus_1_point_0g)
        nodal_sol_df_wing_3_minus_1_point_0g.to_excel(f'sol_dict_minus_1_point_0g_wing_3_wing_strut_jury_{np.rad2deg(theta_minus_1_point_0_g.value)}deg.xlsx') 
        nodal_sol_df_wing_4_minus_1_point_0g = pd.DataFrame(data=sol_dict_wing_4_minus_1_point_0g)
        nodal_sol_df_wing_4_minus_1_point_0g.to_excel(f'sol_dict_minus_1_point_0g_wing_4_wing_strut_jury_{np.rad2deg(theta_minus_1_point_0_g.value)}deg.xlsx') 
        # endregion
...
print("Beam displacement wing(ft) -1.0g: ", displ_minus_1_point_0g)
print('Tip displacement wing(ft) -1.0g: ', displ_minus_1_point_0g[-1, 2])
spanwise_wing_z_disp_minus_1_point_0g = displ_2_point_5g[:, 2]
print('spanwise_wing_z_disp -1.0g',spanwise_wing_z_disp_minus_1_point_0g)
displ1_minus_1_point_0g = sim['eb_beam_minus_1_point_0g.Aframe.comp_model.left_strut_beam_displacement']
print("Beam displacement left strut(ft) -1.0g: ", displ1_minus_1_point_0g)
print('Tip displacement left strut(ft) -1.0g: ', displ1_minus_1_point_0g[-1, 2])
