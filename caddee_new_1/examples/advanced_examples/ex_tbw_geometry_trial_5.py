"TBW baseline wing strut location --> span, chord, sweep and twist geometry working?"
...
#     wing_fuselage_connection_input = system_model.create_input(name='wing_fuselage_connection', shape=(3, ), val=wing_fuselage_connection_m3l.value)
    ...
    # wing_sweep_angle = system_model.create_input(name='wing_sweep_angle', shape=(1,), val=np.deg2rad(8.2), dv_flag = geometry_dv, 
    ...
    # endregion
    kakakka = wing_left_strut_connection_input - wing_right_strut_connection_input
    system_model.add_constraint(kakakka, equals=0)
