"Working - wing VLM --> wing structural full 63"
...
from aframe.core.beam_module_63 import EBBeam, EBBeamForces
import time 
import pickle
import csdl
import pandas as pd
...
from examples.advanced_examples.outputs_63.ex_tbw_geometry_trial_2 import (wing_meshes, htail_meshes, wing_span_dv, wing_root_chord_dv, 
...
# density = 4000.  # SI - only wing mass - 5820
...
wing_beam_tweb_metres = 0.30 * np.ones(num_wing_beam) * inches_to_units 
...
if sizing_wing_strut_jury_individual:
    ...
    if sizing_2_point_5g:
        ...
        # system_model.add_constraint(plus_2_point_5g_eb_beam_outputs_wing.displacements[0], lower=-1.65, upper=0.5)
        ...
        from caddee.utils.aircraft_models.tbw.tbw_propulsion_63 import tbwPropulsionModel
        ...
        print('struct mass actual +2.5g', wing_beam_mass_props.mass)
        print('struct mass after optim +2.5g', sim['eb_beam_2_point_5g.Aframe.comp_model.struct_mass'])
...
if sizing: 
        ...
        # wing_ref_area = tbw_area_outputs_plus_1_point_0g.wing_area 
        # area_value = system_model.create_input('area_plus_1_point_0_g', val=wing_ref_area)
        wing_sweep_angle_minus_1_point_0g = system_model.create_input(name='wing_sweep_angle_minus_1_point_0g', shape=(1,), val=np.deg2rad(14.06),)
        chord_value = system_model.create_input('chord_minus_1_point_0g', val=wing_ref_chord)
        ...
        tbw_viscous_drag_outputs_minus_1_point_0g = tbw_viscous_drag_model_minus_1_point_0g.evaluate(atmos = atmos_minus_1_point_0_g, ac_states=ac_states_minus_1_point_0_g, 
                                                                                                ...
                                                                                                h_tail_area = h_tail_area, strut_area = strut_area, 
                                                                                                sweep_angle = wing_sweep_angle_minus_1_point_0g, mach_number = M_minus_1_point_0_g, angle_beta = angle_beta,) # tbw_viscous_drag_model_63_location_2
        # tbw_viscous_drag_outputs_plus_1_point_0g = tbw_viscous_drag_model_plus_1_point_0g.evaluate(atmos = atmos_1_point_0g, ac_states=ac_states_1_point_0g, 
        #                                                                                         tbw_area_outputs_plus_1_point_0g = tbw_area_outputs_plus_1_point_0g, chord = chord_value, vlm_outputs = vlm_outputs,)
        # tbw_viscous_drag_outputs = tbw_viscous_drag_model.evaluate(area = area_value, chord = chord_value)
        system_model.register_output(tbw_viscous_drag_outputs_minus_1_point_0g)
        ...
        sim = Simulator(caddee_csdl_model,name = 'beam_Save_outputs_strut_63', analytics=True)
        sim['plus_2_point_5g_vlm_model.plus_2_point_5g_vlm_model.VLMSolverModel.VLM_outputs.LiftDrag.evaluation_pt'] = np.array([0., 0., 2.8])
        sim['minus_1g_vlm_model.minus_1g_vlm_model.VLMSolverModel.VLM_outputs.LiftDrag.evaluation_pt'] = np.array([0., 0., 2.8])
        ...
        prob = CSDLProblem(problem_name='beam_tbw_2_and_minus_1_g_1', simulator=sim)
        optimizer = SLSQP(prob, maxiter=200, ftol=1E-5)
        optimizer.solve()
        optimizer.print_results()
