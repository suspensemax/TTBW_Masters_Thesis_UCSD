...
from examples.advanced_examples.outputs_63.tbw_geometry_1_trial_1 import (wing_meshes, htail_meshes, wing_span_dv, wing_root_chord_dv, 
                                                                        wing_mid_chord_left_dv, wing_tip_chord_left_dv,   
                                                                        wing_twist_coefficients, wing_sweep_angle,
...
if sizing_full: 
    ...
    # system_model.add_constraint(minus_1_point_0g_eb_beam_outputs_wing.displacements[0], lower=-1.65, upper=0.5)
    ...
    if twist_sweep_geo_dv:
        ...
        tbw_viscous_drag_outputs_plus_1_point_0g = tbw_viscous_drag_model_plus_1_point_0g.evaluate(atmos = atmos_1_point_0g, ac_states=ac_states_1_point_0g, 
                                                                                                ...
                                                                                                chord = chord_value, vlm_outputs = vlm_outputs, 
                                                                                                h_tail_area = h_tail_area, strut_area = strut_area, 
                                                                                                sweep_angle = wing_sweep_angle, mach_number = M_1_point_0g, angle_beta = angle_beta,) # tbw_viscous_drag_model_63_location_2
    ...
    sim = Simulator(caddee_csdl_model,name = 'tbw_range_full', analytics=True)
    ...
    prob = CSDLProblem(problem_name='who_knows_63', simulator=sim)
