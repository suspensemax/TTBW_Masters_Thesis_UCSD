...
wing_span_dv = system_model.create_input(name='wing_span_dv', shape = (1,), val = 160, dv_flag = geometry_dv, lower = 140., upper = 200., scaler= 1.e-1)
...
if FFD_working_old: 
    ...
    # right
    # gearpod_right_strut_connection_point = np.array([55.573, 12.641, -4.200])
...
#     corner_10 = np.array([66.00, -42.646, 6.4])
#     corner_11 = np.array([66.00, -42.646, 5.7])
#     corner_12 = np.array([56.00, -42.646, 6.4])
#     corner_13 = np.array([56.00, -42.646, 5.7])
...
#     corner_30 = np.array([66.00, 42.646, 6.4])
#     corner_31 = np.array([66.00, 42.646, 5.7])
#     corner_32 = np.array([56.00, 42.646, 6.4])
#     corner_33 = np.array([56.00, 42.646, 5.7])
...
#     corner_43 = np.array([68.00, 85.50, 4.0])
    ...
    left_strut_ffd_block_sect_param.add_sectional_translation(name='left_strut_span_translation_x', axis=0)
    left_strut_ffd_block_sect_param.add_sectional_translation(name='left_strut_span_translation_z', axis=2)
    # left_strut_ffd_block_sect_param.add_sectional_steretch(name='left_strut_chord_stretch', axis=0)
    ...
    # left_strut_chord_stretch_coefficients = m3l.Variable(name= 'left_strut_chord_stretch_coefficients', shape=(2, ), value=np.array([0., 0.]))
    # left_strut_chord_stretch_coefficients = system_model.create_input(name= 'left_strut_chord_stretch_coefficients', shape=(3, ), val=np.array([0.,0., 0.]))
    # left_strut_chord_stretch_b_spline = bsp.BSpline(name='left_strut_chord_b_spline', space=linear_b_spline_curve_3_dof_space, 
    #                                           coefficients=left_strut_chord_stretch_coefficients, num_physical_dimensions=1)
    ...
    sectional_parameters = {
            'left_strut_span_translation_x': left_strut_translation_x,
            'left_strut_span_translation_z': left_strut_translation_z,
            'left_strut_span_stretch': left_strut_span_stretch,
    }
    ...
    # # right_strut_ffd_block_sect_param.add_sectional_stretch(name='right_strut_chord_stretch', axis=0)
    ...
    # # right_strut_chord_stretch_coefficients = m3l.Variable(name= 'right_strut_chord_stretch_coefficients', shape=(2, ), value=np.array([0., 0.]))
    # # right_strut_chord_stretch_coefficients = system_model.create_input(name= 'right_strut_chord_stretch_coefficients', shape=(3, ), val=np.array([0.,0., 0.]))
    # # right_strut_chord_stretch_b_spline = bsp.BSpline(name='right_strut_chord_b_spline', space=linear_b_spline_curve_3_dof_space, 
    # #                                           coefficients=right_strut_chord_stretch_coefficients, num_physical_dimensions=1)
    ...
    # right_strut_ffd_block_sect_param.add_sectional_steretch(name='right_strut_chord_stretch', axis=0)
    ...
    # # left_strut_chord_stretch_coefficients = m3l.Variable(name= 'left_strut_chord_stretch_coefficients', shape=(2, ), value=np.array([0., 0.]))
    # # left_strut_chord_stretch_coefficients = outputs_dict['left_strut_chord_stretch_coefficients']
    # # left_strut_chord_stretch_b_spline = bsp.BSpline(name='left_strut_chord_b_spline', space=linear_b_spline_curve_3_dof_space, 
    # #                                           coefficients=left_strut_chord_stretch_coefficients, num_physical_dimensions=1)

    # # left_strut_ffd_block_sect_param.add_sectional_translation(name='left_strut_sweep_translation', axis=0)

    # # left_strut_sweep_coefficients = system_model.create_input(name='left_strut_sweep_coefficients', shape=(2,),
    # #                                             val=np.array([0., 1.80367015]), dv_flag = geometry_dv, 
    # #                                             lower = np.array([0 , 0.]), 
    # #                                             upper = np.array([40., 0.])) # 10 to 40 degrees sweep
    ...
    # left_strut_span_stretch = left_strut_span_strech_b_spline.evaluate(section_parametric_coordinates)
    # # left_strut_chord_stretch = left_strut_chord_stretch_b_spline.evaluate(section_parametric_coordinates)
    # # left_strut_sectional_sweep = left_strut_sweep_b_spline.evaluate(section_parametric_coordinates)

    # sectional_parameters = {
    #         'left_strut_span_stretch': left_strut_span_stretch,
    #         # 'left_strut_chord_stretch': left_strut_chord_stretch,
    #         # 'left_strut_sweep_translation': left_strut_sectional_sweep,
    # }
    ...
    # # right_strut_chord_stretch_coefficients = m3l.Variable(name= 'right_strut_chord_stretch_coefficients', shape=(2, ), value=np.array([0., 0.]))
    # # right_strut_chord_stretch_coefficients = outputs_dict['right_strut_chord_stretch_coefficients']
    # # right_strut_chord_stretch_b_spline = bsp.BSpline(name='right_strut_chord_b_spline', space=linear_b_spline_curve_3_dof_space, 
    # #                                           coefficients=right_strut_chord_stretch_coefficients, num_physical_dimensions=1)

    # # right_strut_ffd_block_sect_param.add_sectional_translation(name='right_strut_sweep_translation', axis=0)

    # # right_strut_sweep_coefficients = system_model.create_input(name='right_strut_sweep_coefficients', shape=(2,),
    # #                                             val=np.array([0., 0.]), dv_flag = geometry_dv, 
    # #                                             lower = np.array([0 , 0.]), 
    # #                                             upper = np.array([0., 40.])) # 10 to 40 degrees sweep
    ...
    # right_strut_span_stretch = right_strut_span_strech_b_spline.evaluate(section_parametric_coordinates)
    # # right_strut_chord_stretch = right_strut_chord_stretch_b_spline.evaluate(section_parametric_coordinates)
    # # right_strut_sectional_sweep = right_strut_sweep_b_spline.evaluate(section_parametric_coordinates)

    # sectional_parameters = {
    #         'right_strut_span_stretch': right_strut_span_stretch,
    #         # 'right_strut_chord_stretch': right_strut_chord_stretch,
    #         # 'right_strut_sweep_translation': right_strut_sectional_sweep,
    # }
...
FFD_working_old_1 = False 

if FFD_working_old_1: 
    # region True of False
    wing_plot = False
    htail_plot = False
    left_strut_plot = False
...
#     # endregion
    ...
    gearpod_ffd_block_sect_param.add_sectional_translation(name='gearpod_span_stretch', axis=1)
#     gearpod_ffd_block_sect_param.add_sectional_stretch(name='gearpod_chord_stretch', axis=0)
    ...
    gearpod_span_stretch_coefficients = system_model.create_input(name= 'gearpod_span_stretch_coefficients', shape=(2, ), val=np.array([0.,0.]))
...
#                                               coefficients=gearpod_chord_stretch_coefficients, num_physical_dimensions=1)
    ...
    gearpod_span_stretch = gearpod_span_strech_b_spline.evaluate(section_parametric_coordinates)
#     gearpod_chord_stretch = gearpod_chord_stretch_b_spline.evaluate(section_parametric_coordinates)

    sectional_parameters = {
            'gearpod_span_stretch': gearpod_span_stretch,
...
#     tbw_param_solver.declare_state('gearpod_span_stretch_coefficients', gearpod_span_stretch_coefficients)
...
# # #     # region gearpod try 1

# # #     gearpod_span_stretch_coefficients = outputs_dict['gearpod_span_stretch_coefficients']
...
#     # gearpod_span_stretch_coefficients = m3l.Variable(name= 'gearpod_span_stretch_coefficients', shape=(2, ), value=np.array([0.,0.]))
# #     gearpod_left_strut_connection': array([2.03372072]), 'gearpod_right_strut_connection': array([2.08249014])
#     gearpod_span_stretch_coefficients = system_model.create_input(name= 'gearpod_span_stretch_coefficients', shape=(2, ), val=np.array([-1.55,1.55]))
#     gearpod_span_strech_b_spline = bsp.BSpline(name='gearpod_span_b_spline', space=linear_b_spline_curve_2_dof_space, 
#                                             coefficients=gearpod_span_stretch_coefficients, num_physical_dimensions=1)
...
FFD_working_old_2 = False # span and chord wokring 

if FFD_working_old_2: 
    # region True of False
    wing_plot = False
    htail_plot = False
    left_strut_plot = False
...
FFD_working_old_5 = False # span and chord and twist working
...
FFD_working_old_6 = True # span and chord and twist and sweep
...
#     wing_fuselage_connection_input = system_model.create_input(name='wing_fuselage_connection', shape=(3, ), val=wing_fuselage_connection_m3l.value)
    ...
    wing_sweep_angle = system_model.create_input(name='wing_sweep_angle', shape=(1,), val=np.deg2rad(12.16), dv_flag = geometry_dv, 
    ...
    right_strut_sweep_coefficients[np.array([1])] = (-1/2) *  wing_sweep_coefficients[np.array([2])]
...
FFD_working_old_3 = False # sweep and twist a

if FFD_working_old_3: 
    # region True of False
    wing_plot = False
    htail_plot = False
    left_strut_plot = False
...
#     wing_fuselage_connection_input = system_model.create_input(name='wing_fuselage_connection', shape=(3, ), val=wing_fuselage_connection_m3l.value)
    ...
    #                                             value=np.array([0., 0., 0., 0., 0.]), dv_flag = geometry_dv, 
    #                                             lower = np.array([-10., -10., -10., -10., -10.]), 
    #                                             upper = np.array([10., 10., 10., 10., 10.]))
    
    # wing_twist_coefficients = system_model.create_input(name='wing_twist_coefficients', shape=(5,),
    #                                             val=np.array([0., 0., 0., 0., 0.]), dv_flag = geometry_dv, 
    #                                             lower = np.array([-10., -10., -10., -10., -10.]), 
    #                                             upper = np.array([10., 10., 10., 10., 10.]))    
    ...
    defg = wing_twist_coefficients[np.array([2])] - wing_twist_coefficients[np.array([0])]
    # defg = wing_twist_coefficients[np.array([4])] - wing_twist_coefficients[np.array([0])] 
    # hijk = wing_twist_coefficients[np.array([3])] - wing_twist_coefficients[np.array([1])]
    system_model.register_output(defg)
    # system_model.register_output(hijk)
    system_model.add_constraint(defg, equals=0)
    # system_model.add_constraint(hijk, equals=0)
    ...
    wing_sweep_coefficients = system_model.create_input(name='wing_sweep_coefficients', shape=(3,),
                                                val=np.array([0., 0., 0]), dv_flag = geometry_dv, 
                                                upper = np.array([-10., 0., -10.]), 
                                                lower = np.array([-90., 0., -90.])) # 10 to 40 degrees sweep
    ...
    # le_root_new_x = 47.231
    le_root_new_x = 47.231 - wing_sweep_coefficients[np.array([1])] 
    le_root_new_point = np.pad(le_root_new_x.value, (0, 2), 'constant')

    le_root_new_point[1] = 0.
    le_root_new_point[2] = 6.937

    # le_tip_new_x = 68.035 - wing_sweep_coefficients[np.array([2])] + (0.25 * wing_tip_chord_left_dv[np.array([0])])
    le_tip_new_x = 68.035 - wing_sweep_coefficients[np.array([0])] 
    # le_tip_new_x = 68.035  

    le_tip_new_point = np.pad(le_tip_new_x.value, (0, 2), 'constant')

    le_tip_new_point[1] = -85.291
    le_tip_new_point[2] = 4.704


    # Calculate vectors AB and AB'
    AB = wing_le_left - le_root_new_point
    AB_prime = le_tip_new_point - le_root_new_point

    # Calculate the dot product of AB and AB'
    dot_product = np.dot(AB, AB_prime)

    # Calculate the magnitudes of AB and AB'
    magnitude_AB = np.linalg.norm(AB)
    magnitude_AB_prime = np.linalg.norm(AB_prime)
    ...
    print(angle_degrees)
    mach_number = 0.70
    # sweep = csdl.cos(angle_degrees)
    # wing_wave_cf = self.parameters['wing_wave_cf']
    first_cd_value = (0.02699476221/sweep)**2
    first_cd = system_model.create_input(name = 'first_cd', shape = (1,), val = first_cd_value)
    # print(first_cd.val)
    mach_number_square_value = mach_number**2

    mach_number_sqrt_value = (1-mach_number_square_value)**(1/2)
    mach_number_square = system_model.create_input(name = 'mach_number_square', shape = (1,), val = mach_number_square_value)
    mach_number_sqrt = system_model.create_input(name = 'mach_number_sqrt', shape = (1,), val = mach_number_sqrt_value)

    # exit()
    # mach_number_sqrt = csdl.exp(mach_number_square-1)
    Cd_wave_after_sweep = first_cd *(mach_number_square/mach_number_sqrt) 
    # system_model.add_constraint(Cd_wave_after_sweep, scaler = 1e3)
    # exit()
    section_parametric_coordinates = np.linspace(0., 1., wing_ffd_block_sect_param.num_sections).reshape((-1,1))
    wing_wingspan_stretch = wingspan_stretch_b_spline.evaluate(section_parametric_coordinates)
    wing_sectional_chord_stretch = wing_chord_stretch_b_spline.evaluate(section_parametric_coordinates)
    ...
    # gearpod_span_stretch_coefficients = m3l.Variable(name= 'gearpod_span_stretch_coefficients', shape=(2, ), value=np.array([0.,0.]))
    gearpod_translation_y_coefficients = outputs_dict['gearpod_translation_y_coefficients']
    gearpod_translation_x_coefficients = outputs_dict['gearpod_translation_x_coefficients']
    gearpod_translation_z_coefficients = outputs_dict['gearpod_translation_z_coefficients']
...
FFD_working_old_4 = False # Twist slowly slowly

if FFD_working_old_4: 
    # region True of False
    wing_plot = False
    htail_plot = False
    left_strut_plot = False
...
if FFD_try: 
    ...
    # left_jury_translation_x_coefficients = system_model.create_input('left_jury_translation_x_coefficients', shape=(1, ), val=np.array([5]))
    left_jury_translation_x_coefficients = system_model.create_input('left_jury_translation_x_coefficients', shape=(1, ), val=np.array([0]))
    left_jury_translation_y_coefficients = system_model.create_input('left_jury_translation_y_coefficients', shape=(1, ), val=np.array([0]))
    left_jury_stretch_z_coefficients = system_model.create_input('left_jury_stretch_z_coefficients', shape=(1, ), val=np.array([0]))
    ...
    # right_jury_translation_x_coefficients = system_model.create_input('right_jury_translation_x_coefficients', shape=(1, ), val=np.array([5]))
    right_jury_translation_x_coefficients = system_model.create_input('right_jury_translation_x_coefficients', shape=(1, ), val=np.array([0]))
    right_jury_translation_y_coefficients = system_model.create_input('right_jury_translation_y_coefficients', shape=(1, ), val=np.array([0]))
    right_jury_stretch_z_coefficients = system_model.create_input('right_jury_stretch_z_coefficients', shape=(1, ), val=np.array([0]))
    ...
    # wing_sweep_coefficients = m3l.Variable(name='wing_sweep_coefficients', shape=(3,),
    #                                             value=np.array([0., 0., 0.]), dv_flag = geometry_dv, 
    #                                             lower = np.array([10., 0., 10., ]), 
    #                                             upper = np.array([40., 0., 40.]))
    wing_sweep_coefficients = system_model.create_input(name='wing_sweep_coefficients', shape=(3,),
                                                val=np.array([-20., 0., -20.]), dv_flag = geometry_dv, 
                                                upper = np.array([-10., 0., -10.]), 
                                                lower = np.array([-71.72, 0., -71.72])) # 10 to 40 degrees sweep
    # wing_sweep_coefficients = system_model.create_input(name='wing_sweep_coefficients', shape=(3,),
    #                                             val=np.array([0., 0., 0.]), dv_flag = geometry_dv, 
    #                                             upper = np.array([-12.63, 0., -12.63, ]), 
    #                                             lower = np.array([-71.72, 0., -71.72])) # 10 to 40 degrees sweep

    from caddee.utils.aircraft_models.tbw.tbw_area_ffd import tbwSweep
    tbw_sweep_model_plus_1_point_0g = tbwSweep(
        name='TBW_sweep_plus_1_point_0g',
        counter = 'plus_1_point_0g',
    )
    tbw_sweep_outputs_plus_1_point_0g = tbw_sweep_model_plus_1_point_0g.evaluate(wing_sweep_coefficients = wing_sweep_coefficients,)

    system_model.register_output(tbw_sweep_outputs_plus_1_point_0g)

    wing_sweep_b_spline = bsp.BSpline(name='wing_sweep_b_spline', space=linear_b_spline_curve_3_dof_space,
                                                coefficients=tbw_sweep_outputs_plus_1_point_0g.wing_sweep, num_physical_dimensions=1)
    ...
    # left_strut_sweep_coefficients = m3l.Variable(name='left_strut_sweep_coefficients', shape=(3,),
    #                                             value=np.array([0., 0., 0.]), dv_flag = geometry_dv, 
    #                                             lower = np.array([10., 0., 10., ]), 
    #                                             upper = np.array([40., 0., 40.]))
    # left_strut_sweep_coefficients = system_model.create_input(name='left_strut_sweep_coefficients', shape=(2,),
    #                                             val=np.array([10/2, 0.])) # 10 to 40 degrees sweep
    # left_strut_sweep_coefficients = system_model.create_input(name='left_strut_sweep_coefficients', shape=(3,),
    #                                             val=np.array([0., 0., 0.]), dv_flag = geometry_dv, 
    #                                             upper = np.array([-12.63, 0., -12.63, ]), 
    #                                             lower = np.array([-71.72, 0., -71.72])) # 10 to 40 degrees sweep
    # left_strut_sweep_coefficients = system_model.create_input(name='left_strut_sweep_coefficients', shape=(2,),
    #                                             val=np.array([((-wing_sweep_coefficients.value[0])/2), (wing_sweep_coefficients.value[1]/2)])) # 10 to 40 degrees sweep
    left_strut_sweep_coefficients = system_model.create_input(name='left_strut_sweep_coefficients', shape=(2,),
                                                val=np.array([((-wing_sweep_coefficients.value[0])/2), (wing_sweep_coefficients.value[1]/2)]), dv_flag = geometry_dv, 
                                                lower = np.array([((-wing_sweep_coefficients.upper[0])/2), (wing_sweep_coefficients.upper[1]/2)]), 
                                                upper = np.array([((-wing_sweep_coefficients.upper[0])/2), (wing_sweep_coefficients.upper[1]/2)]))    
    ...
    # right_strut_sweep_coefficients = m3l.Variable(name='right_strut_sweep_coefficients', shape=(3,),
    #                                             value=np.array([0., 0., 0.]), dv_flag = geometry_dv, 
    #                                             lower = np.array([10., 0., 10., ]), 
    #                                             upper = np.array([40., 0., 40.]))
    # right_strut_sweep_coefficients = system_model.create_input(name='right_strut_sweep_coefficients', shape=(2,),
    #                                             val=np.array([0., 10/2])) # 10 to 40 degrees sweep
    # right_strut_sweep_coefficients = system_model.create_input(name='right_strut_sweep_coefficients', shape=(3,),
    #                                             val=np.array([0., 0., 0.]), dv_flag = geometry_dv, 
    #                                             upper = np.array([-12.63, 0., -12.63, ]), 
    #                                             lower = np.array([-71.72, 0., -71.72])) # 10 to 40 degrees sweep
    right_strut_sweep_coefficients = system_model.create_input(name='right_strut_sweep_coefficients', shape=(2,),
    ...
    # right_strut_sweep_coefficients = system_model.create_input(name='right_strut_sweep_coefficients', shape=(2,),
    #                                              val=np.array([(wing_sweep_coefficients.name[1]/2), ((-wing_sweep_coefficients.name[2])/2)])) 
    right_strut_sweep_b_spline = bsp.BSpline(name='right_strut_sweep_b_spline', space=linear_b_spline_curve_2_dof_space,
                                                coefficients=right_strut_sweep_coefficients, num_physical_dimensions=1)
    ...
    # left_jury_translation_x_coefficients = system_model.create_input('left_jury_translation_x_coefficients_a', shape=(1, ), val=np.array([2.5]))
    # left_jury_translation_x_coefficients = system_model.create_input('left_jury_translation_x_coefficients_a', shape=(1, ), val=np.array([(left_strut_sweep_coefficients.value[0]/2)]))
    left_jury_translation_x_coefficients = system_model.create_input('left_jury_translation_x_coefficients_a', shape=(1, ), val=np.array([(left_strut_sweep_coefficients.value[0]/2)]), dv_flag = geometry_dv, 
                                                                     lower = np.array([(left_strut_sweep_coefficients.lower[0]/2)]),
                                                                     upper = np.array([(left_strut_sweep_coefficients.upper[0]/2)]))
    ...
    # right_jury_translation_x_coefficients = system_model.create_input('right_jury_translation_x_coefficients_a', shape=(1, ), val=np.array([(right_strut_sweep_coefficients.value[1]/2)]))
    right_jury_translation_x_coefficients = system_model.create_input('right_jury_translation_x_coefficients_a', shape=(1, ), val=np.array([(right_strut_sweep_coefficients.value[1]/2)]), dv_flag = geometry_dv, 
                                                                     lower = np.array([(right_strut_sweep_coefficients.lower[1]/2)]),
                                                                     upper = np.array([(right_strut_sweep_coefficients.upper[1]/2)]))
    right_jury_ffd_block_translation_x_b_spline = bsp.BSpline(name='right_jury_translation_x_bspline', space=constant_b_spline_curve_1_dof_space, 
...
FFD_working_old_66 = False # span and chord and twist and sweep scam

if FFD_working_old_66:
...
#     wing_fuselage_connection_input = system_model.create_input(name='wing_fuselage_connection', shape=(3, ), val=wing_fuselage_connection_m3l.value)
    ...
    # Convert the angle to degrees
    angle_degrees = np.degrees(angle_radians)
    angle_angle_degrees = system_model.create_input(name = 'angle_degrees', shape = (1,), val = angle_degrees)

    print(angle_degrees)

    mach_number = 0.70
    mach_number_perpendicular = mach_number * sweep
    mach_number_perpendicular_square = mach_number_perpendicular **2
    constant = 4 * 0.27324 * (0.154**2)
    # constant = 4 * 0.027324 * (0.154**2)
    # constant = 4 * (-0.02) * (0.154**2)
    # constant = 4 * (0.015) * (0.154**2)
    mach_number_perpendicular_sqrt = (1-mach_number_perpendicular_square)**(1/2)
    critical_mach_number_square = 0.5 **2
    critical_mach_number_by_perpendicular = critical_mach_number_square/mach_number_perpendicular_square
    vlaue = (constant/mach_number_perpendicular_sqrt)*(1-critical_mach_number_by_perpendicular)
    delta_cd = system_model.create_input(name = 'delta_cd', shape = (1,), val = vlaue)
    # Cd_0 = system_model.create_input(name = 'Cd_0', shape = (1,), val = 0.00121)
    Cd_0 = system_model.create_input(name = 'Cd_0', shape = (1,), val = 0.0007)
    Cd_wave = Cd_0 + delta_cd

    # system_model.add_constraint(Cd_wave, scaler = 1000)
...
#     gearpod_chord_stretch = gearpod_chord_stretch_b_spline.evaluate(section_parametric_coordinates)
    ...
    # le_root_new_x = 47.231
    le_root_new_x = 47.231 - wing_sweep_coefficients[np.array([1])] + (0.25 * wing_root_chord_dv[np.array([0])])
    le_root_new_point = np.pad(le_root_new_x.value, (0, 2), 'constant')
    ...
    wing_le_left_new = np.array([le_root_new_point[0], le_tip_new_point[1], le_tip_new_point[2]])
    AB = wing_le_left_new - le_root_new_point
    AB_prime = le_tip_new_point - le_root_new_point
    ...
    angle_degrees = np.degrees(angle_radians)
    angle_angle_degrees = system_model.create_input(name = 'angle_degrees', shape = (1,), val = angle_degrees)
    sweep_cos_angle = system_model.create_input(name = 'sweep_cos_angle', shape = (1,), val = cos_theta)
    print(angle_degrees)
