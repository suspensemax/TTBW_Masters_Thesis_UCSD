...
wing_beam_ttop_metres = wing_beam_ttop_inches_skin * inches_to_units * 2.5
# wing_beam_ttop_metres = 0.5*np.ones(num_wing_beam) * inches_to_units

wing_beam_t_top = system_model.create_input(name='wing_beam_ttop' ,val=wing_beam_ttop_metres, dv_flag=sizing, lower=0.15 * inches_to_units, upper=0.875 * inches_to_units, scaler=10) # lower=0.00127
wing_beam_t_bot = system_model.create_input(name='wing_beam_tbot' ,val=wing_beam_ttop_metres, dv_flag=sizing, lower=0.15 * inches_to_units, upper=0.875 * inches_to_units, scaler=10)
wing_beam_tweb = system_model.create_input(name='wing_beam_tweb' ,val=wing_beam_ttop_metres, dv_flag=sizing, lower=0.15 * inches_to_units, upper=0.875 * inches_to_units, scaler=10)
...
strut_beam_metres = strut_beam_inches_skin * inches_to_units * 2.5
...
left_strut_beam_t_top = system_model.create_input(name='left_strut_beam_ttop' ,val=strut_beam_metres, dv_flag=sizing, lower=0.15 * inches_to_units, upper=0.625 * inches_to_units, scaler=10) # lower=0.00127
left_strut_beam_t_bot = system_model.create_input(name='left_strut_beam_tbot' ,val=strut_beam_metres, dv_flag=sizing, lower=0.15 * inches_to_units, upper=0.625 * inches_to_units, scaler=10)
left_strut_beam_tweb = system_model.create_input(name='left_strut_beam_tweb' ,val=strut_beam_metres, dv_flag=sizing, lower=0.15 * inches_to_units, upper=0.625 * inches_to_units, scaler=10)
# left_strut_beam_tweb = system_model.create_input(name='left_strut_beam_tweb' ,val=strut_beam_metres_skin, dv_flag=sizing, lower=0.01 * inches_to_units, upper=0.625 * inches_to_units, scaler=1E3)
...
right_strut_beam_t_top = system_model.create_input(name='right_strut_beam_ttop' ,val=strut_beam_metres, dv_flag=sizing, lower=0.15 * inches_to_units, upper=0.625 * inches_to_units, scaler=10) # lower=0.00127
right_strut_beam_t_bot = system_model.create_input(name='right_strut_beam_tbot' ,val=strut_beam_metres, dv_flag=sizing, lower=0.15 * inches_to_units, upper=0.625 * inches_to_units, scaler=10)
right_strut_beam_tweb = system_model.create_input(name='right_strut_beam_tweb' ,val=strut_beam_metres, dv_flag=sizing, lower=0.15 * inches_to_units, upper=0.625 * inches_to_units, scaler=10)
# right_strut_beam_tweb = system_model.create_input(name='right_strut_beam_tweb' ,val=strut_beam_metres_skin, dv_flag=sizing, lower=0.01 * inches_to_units, upper=0.625 * inches_to_units, scaler=1E3)


jury_beam_metres = 0.15 * inches_to_units * np.ones((num_jury_beam, )) * 2.5
...
left_jury_beam_t_top = system_model.create_input(name='left_jury_beam_ttop' ,val=jury_beam_metres, dv_flag=sizing, lower=0.01 * inches_to_units, upper=0.250 * inches_to_units, scaler=10) # lower=0.00127
left_jury_beam_t_bot = system_model.create_input(name='left_jury_beam_tbot' ,val=jury_beam_metres, dv_flag=sizing, lower=0.01 * inches_to_units, upper=0.250 * inches_to_units, scaler=10)
left_jury_beam_tweb = system_model.create_input(name='left_jury_beam_tweb' ,val=jury_beam_metres, dv_flag=sizing, lower=0.01 * inches_to_units, upper=0.250 * inches_to_units, scaler=10)
right_jury_beam_t_top = system_model.create_input(name='right_jury_beam_ttop' ,val=jury_beam_metres, dv_flag=sizing, lower=0.01 * inches_to_units, upper=0.250 * inches_to_units, scaler=10) # lower=0.00127
right_jury_beam_t_bot = system_model.create_input(name='right_jury_beam_tbot' ,val=jury_beam_metres, dv_flag=sizing, lower=0.01 * inches_to_units, upper=0.250 * inches_to_units, scaler=10)
right_jury_beam_tweb = system_model.create_input(name='right_jury_beam_tweb' ,val=jury_beam_metres, dv_flag=sizing, lower=0.01 * inches_to_units, upper=0.250 * inches_to_units, scaler=10)
