...
vertex01_left_strut = np.array([55.252, -17.806, -3.259]) # left leading 2
vertex02_left_strut = np.array([57.186, -30.719, -0.906]) # left leading 3
vertex03_left_strut = np.array([59.403, -38.466, 0.506]) # left leading 4
vertex04_left_strut = np.array([59.507, -46.214, 1.917]) # left leading 5
vertex05_left_strut = np.array([61.441, -59.126, 4.270]) # left leading 6
vertex06_left_strut = np.array([63.272, -64.291, 5.211]) # left leading 7

vertex10_left_strut = np.array([57.309, -12.641, -4.200]) # left trailing 1
vertex11_left_strut = np.array([59.178, -17.806, -3.259]) # left trailing 2
vertex12_left_strut = np.array([61.112, -30.719, -0.906]) # left trailing 3
vertex13_left_strut = np.array([61.215, -38.466, 0.506]) # left trailing 4
vertex14_left_strut = np.array([63.433, -46.214, 1.917]) # left trailing 5
vertex15_left_strut = np.array([65.367, -59.126, 4.270]) # left trailing 6                
vertex16_left_strut = np.array([65.083, -64.291, 5.211]) # left trailing 7
...
vertex01_right_strut = np.array([55.252, 17.806, -3.259]) # right leading 2
vertex02_right_strut = np.array([57.186, 30.719, -0.906]) # right leading 3
vertex03_right_strut = np.array([59.403, 38.466, 0.506]) # right leading 4
vertex04_right_strut = np.array([59.507, 46.214, 1.917]) # right leading 5
vertex05_right_strut = np.array([61.441, 59.126, 4.270]) # right leading 6
vertex06_right_strut = np.array([63.272, 64.291, 5.211]) # right leading 7

vertex10_right_strut = np.array([57.309, 12.641, -4.200]) # right trailing 1
vertex11_right_strut = np.array([59.178, 17.806, -3.259]) # right trailing 2
vertex12_right_strut = np.array([61.112, 30.719, -0.906]) # right trailing 3
vertex13_right_strut = np.array([61.215, 38.466, 0.506]) # right trailing 4
vertex14_right_strut = np.array([63.433, 46.214, 1.917]) # right trailing 5
vertex15_right_strut = np.array([65.367, 59.126, 4.270]) # right trailing 6                
vertex16_right_strut = np.array([65.083, 64.291, 5.211]) # right trailing 7
...
left_jury_le_left = np.array([59.732, -38.535, 0.486])
left_jury_le_right = np.array([59.063, -38.535, 5.935])
left_jury_te_left = np.array([60.688, -38.535, 0.486])
left_jury_te_right = np.array([60.248, -38.535, 5.935])
...
right_jury_le_left = np.array([59.732, 38.535, 0.486])
right_jury_le_right = np.array([59.063, 38.535, 5.935])
right_jury_te_left = np.array([60.688, 38.535, 0.486])
right_jury_te_right = np.array([60.248, 38.535, 5.935])
...
if FFD_working_old_5: 
    ...
    # left -ve y
    wing_left_strut_connection_point = np.array([64.161, -64.304, 5.357])
    ...
    wing_right_strut_connection_point = np.array([64.161, 64.304, 5.357])
    ...
    # left
    wing_left_jury_connection_point = np.array([59.644, -38.535, 5.935])
    ...
    # right 
    wing_right_jury_connection_point = np.array([59.644, 38.535, 5.935])
    ...
    # left
    left_jury_left_strut_connection_point = np.array([60.201, -38.535, 0.486])
    ...
    #right
    right_jury_right_strut_connection_point = np.array([60.201, 38.535, 0.486])
...
#     wing_fuselage_connection_input = system_model.create_input(name='wing_fuselage_connection', shape=(3, ), val=wing_fuselage_connection_m3l.value)
    ...
    wing_sweep_angle = system_model.create_input(name='wing_sweep_angle', shape=(1,), val=np.deg2rad(30.17), dv_flag = geometry_dv, 
    ...
    left_strut_sweep_coefficients[np.array([0])] = (-1/1.45) * wing_sweep_coefficients[np.array([0])]
    ...
    right_strut_sweep_coefficients[np.array([1])] = (-1/1.45) *  wing_sweep_coefficients[np.array([2])]
