...
if climb:
    ...
    # system_model.add_constraint(climb_tbw_fuel_burn_outputs_plus_1_point_0g.time,lower = 0.18,upper = 0.5)
    ...
    sim = Simulator(caddee_csdl_model,name = f'Forward_tbw_trim_{counter}_climb_baseline_1g_SLSQP', analytics=True)
    ...
    print('time_to_climb (hr)', sim['climb_plus_1_point_0g_and_2_point_5g_and_minus_1_point_0g_tbw_climb_model.climb_delta_t_m3l']*60)
    print('climb flight path angle', np.rad2deg(sim['climb_flight_path_angle']))
    # exit()
    prob = CSDLProblem(problem_name=f'mission_segment_climb_{counter}_SLSQP', simulator=sim)
    # snopt_options = {
    ...
    # optimizer = SLSQP(prob, solver_options={'maxiter':520, 'ftol':1E-5})
...
if descent:
    ...
    # system_model.add_constraint(descent_plus_1_point_0g_trim_variables.accelerations, equals=0., scaler = 5)
    # system_model.add_objective(tbw_L_over_D_outputs_plus_1_point_0g.L_over_D, scaler = -1)
    # system_model.add_constraint(tbw_L_over_D_outputs_plus_1_point_0g.L_over_D, scaler = -1)
    ...
    # system_model.add_objective(descent_tbw_fuel_burn_outputs_plus_1_point_0g.fuel_burn, scaler = 1.e-2)
    system_model.add_objective(descent_tbw_fuel_burn_outputs_plus_1_point_0g.descent_fuel, scaler = 1.e-3)
    counter = 2
    caddee_csdl_model = system_model.assemble_csdl()
    sim = Simulator(caddee_csdl_model,name = f'Forward_tbw_trim_{counter}_descent_baseline_1g_SLSQP', analytics=True)
    ...
    print('time_to_descent (hr)', sim['descent_plus_1_point_0g_and_2_point_5g_and_minus_1_point_0g_tbw_descent_model.descent_delta_t_m3l']*60)
    print('descent flight path angle', np.rad2deg(sim['descent_flight_path_angle']))
    # exit()
    prob = CSDLProblem(problem_name=f'mission_segment_descent_{counter}_SLSQP', simulator=sim)
    # snopt_options = {
    #     'Major iterations': 500, 
    #     # 'Major iterations': 400, 
    #     'Major optimality': 1e-4, 
...
if cruise: 
    ...
    caddee_csdl_model = system_model.assemble_csdl()
    sim = Simulator(caddee_csdl_model,name = 'Forward_tbw_trim_baseline_1g_cruise', analytics=True)
    ...
    # exit()
    prob = CSDLProblem(problem_name='mission_segment_cruise_1_cruise', simulator=sim)
    # optimizer = SLSQP(prob, solver_options={'maxiter':520, 'ftol':1E-5})
    optimizer = SLSQP(prob, maxiter=400, ftol=1E-5)
    optimizer.solve()
    optimizer.print_results()
...
if descent_old:
    ...
    descent_M = system_model.create_input('descent_M', val=0.70, dv_flag=False, lower=0.65, upper=0.85)
    # r_1_point_0g = system_model.create_input('range_1_point_0g', val=6482000) # in 'nautical miles'
    descent_pitch = system_model.create_input('descent_pitch', val=np.deg2rad(-2), dv_flag=True, lower=np.deg2rad(-20), upper=np.deg2rad(20), scaler=10)
    ...
    descent_plus_1_point_0_g_elevator = system_model.create_input('descent_plus_1_point_0_g_elevator', val=np.deg2rad(-3), dv_flag=True, lower=np.deg2rad(-20), upper=np.deg2rad(20))
    ...
    system_model.add_objective(descent_tbw_L_over_D_outputs_plus_1_point_0g.L_over_D, scaler = -1)
    # system_model.add_constraint(tbw_L_over_D_outputs_plus_1_point_0g.L_over_D, scaler = -1)
    ...
    # # from caddee.utils.aircraft_models.tbw.tbw_fuel_burn import Tbw_fuel_burn_Model
    # # from caddee.utils.aircraft_models.tbw.tbw_fuel_burn_climb import Tbw_fuel_burn_Model
    # from caddee.utils.aircraft_models.tbw.tbw_fuel_burn_descent import Tbw_fuel_burn_Model
    ...
    # # tbw_fuel_burn_outputs_plus_1_point_0g = tbw_fuel_burn_plus_1_point_0g.evaluate(L_over_D = tbw_L_over_D_outputs_plus_1_point_0g, total_mass_props = total_mass_props.mass, thrust = tbw_left_propulsion_outputs_plus_1_point_0g.thrust)
    # # tbw_fuel_burn_outputs_plus_1_point_0g = tbw_fuel_burn_plus_1_point_0g.evaluate(L_over_D = tbw_L_over_D_outputs_plus_1_point_0g, total_mass_props = total_mass_props, thrust = tbw_left_propulsion_outputs_plus_1_point_0g)
    # descent_tbw_fuel_burn_outputs_plus_1_point_0g = descent_tbw_fuel_burn_plus_1_point_0g.evaluate(total_drag = descent_tbw_L_over_D_outputs_plus_1_point_0g, 
    #                                                                                wing_beam_mass_props = wing_beam_mass_props.mass, 
    #                                                                        tbw_mass_properties = tbw_mass_properties.mass, 
    ...
    # system_model.register_output(descent_tbw_fuel_burn_outputs_plus_1_point_0g)
    # # system_model.add_constraint(descent_tbw_fuel_burn_outputs_plus_1_point_0g.time,lower = 10,upper = 30, scaler= 1.e-2)
    # system_model.add_objective(descent_tbw_fuel_burn_outputs_plus_1_point_0g.fuel_burn, scaler = 1.e-2)
    # # system_model.add_objective(descent_tbw_fuel_burn_outputs_plus_1_point_0g.fuel_burn, scaler = 1.e-3)
    counter = '5b'
    caddee_csdl_model = system_model.assemble_csdl()
    sim = Simulator(caddee_csdl_model,name = f'Forward_tbw_trim_{counter}_descent_baseline_1g_SLSQP', analytics=True)
    sim['descent_plus_1g_vlm_model.descent_plus_1g_vlm_model.VLMSolverModel.VLM_outputs.LiftDrag.evaluation_pt'] = np.array([0., 0., 2.8])
    ...
    print('Cf_wo_area_fraction_total_viscous_drag_model', sim['descent_plus_1_point_0g_tbw_viscous_drag_model.Cf_wo_area_fraction'])
    print('Area from my model', sim['plus_1_point_0_g_tbw_area_model.wing_area_value'])
    # print('ROC_descent_m3l', sim['descent_plus_1_point_0g_and_2_point_5g_and_minus_1_point_0g_tbw_fuel_burn_model.ROC_descent_m3l'])
    # # print('ROC_with_flight_path_angle', sim['descent_plus_1_point_0g_and_2_point_5g_and_minus_1_point_0g_tbw_fuel_burn_model.ROC_with_flight_path_angle'])
    # print('fuel_burned', sim['descent_plus_1_point_0g_and_2_point_5g_and_minus_1_point_0g_tbw_fuel_burn_model.fuel_burn_descent_m3l'])
    # print('time_to_descent (hr)', sim['descent_plus_1_point_0g_and_2_point_5g_and_minus_1_point_0g_tbw_fuel_burn_model.time_to_descent_descent_m3l'])
    # # print('final_weight', sim['climb_plus_1_point_0g_and_2_point_5g_and_minus_1_point_0g_tbw_fuel_burn_model.final_weight'])
    prob = CSDLProblem(problem_name=f'mission_segment_descent_{counter}_SLSQP', simulator=sim)
    # snopt_options = {
