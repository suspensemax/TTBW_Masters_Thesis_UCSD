...
#     counter = '40_SLSPQ'
    counter = 1
    sim = Simulator(caddee_csdl_model,name = f'just_sizing_outputs_outputs_40', analytics=True)
    ...
    prob = CSDLProblem(problem_name=f'just_sizing_outputs_outputs_40_optimization', simulator=sim)
