...
from examples.advanced_examples.outputs_40.tbw_geometry_sizing import (wing_meshes, htail_meshes, wing_span_dv, wing_root_chord_dv, 
...
if sizing_full:
    ...
    sim = Simulator(caddee_csdl_model,name = f'just_sizing_outputs_outputs_40_{counter}', analytics=True)
    ...
    exit()
    prob = CSDLProblem(problem_name=f'just_sizing_outputs_outputs_40_optimization_{counter}', simulator=sim)
