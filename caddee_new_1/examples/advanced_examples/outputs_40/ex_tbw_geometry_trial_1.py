...
vertex01_left_strut = np.array([54.825, -14.782, -3.231]) # left leading 2
vertex02_left_strut = np.array([55.690, -20.135, -0.810]) # left leading 3
vertex03_left_strut = np.array([57.267, -23.347, 0.643]) # left leading 4
vertex04_left_strut = np.array([56.729, -26.558, 2.096]) # left leading 5
vertex05_left_strut = np.array([57.595, -31.911, 4.518]) # left leading 6
vertex06_left_strut = np.array([58.998, -34.052, 5.487]) # left leading 7

vertex10_left_strut = np.array([57.309, -12.641, -4.200]) # left trailing 1
vertex11_left_strut = np.array([58.750, -14.782, -3.231]) # left trailing 2
vertex12_left_strut = np.array([59.616, -20.135, -0.810]) # left trailing 3
vertex13_left_strut = np.array([59.079, -23.347, 0.643]) # left trailing 4
vertex14_left_strut = np.array([60.655, -26.558, 2.096]) # left trailing 5
vertex15_left_strut = np.array([61.521, -31.911, 4.518]) # left trailing 6                
vertex16_left_strut = np.array([60.810, -34.052, 5.487]) # left trailing 7
...
vertex01_right_strut = np.array([54.825, 14.782, -3.231]) # right leading 2
vertex02_right_strut = np.array([55.690, 20.135, -0.810]) # right leading 3
vertex03_right_strut = np.array([57.267, 23.347, 0.643]) # right leading 4
vertex04_right_strut = np.array([56.729, 26.558, 2.096]) # right leading 5
vertex05_right_strut = np.array([57.595, 31.911, 4.518]) # right leading 6
vertex06_right_strut = np.array([58.998, 34.052, 5.487]) # right leading 7

vertex10_right_strut = np.array([57.309, 12.641, -4.200]) # right trailing 1
vertex11_right_strut = np.array([58.750, 14.782, -3.231]) # right trailing 2
vertex12_right_strut = np.array([59.616, 20.135, -0.810]) # right trailing 3
vertex13_right_strut = np.array([59.079, 23.347, 0.643]) # right trailing 4
vertex14_right_strut = np.array([60.655, 26.558, 2.096]) # right trailing 5
vertex15_right_strut = np.array([61.521, 31.911, 4.518]) # right trailing 6                
vertex16_right_strut = np.array([60.810, 34.052, 5.487]) # right trailing 7
...
left_jury_le_left = np.array([57.537, -23.326, 0.618])
left_jury_le_right = np.array([56.919, -23.326, 5.657])
left_jury_te_left = np.array([58.493, -23.326, 0.618])
left_jury_te_right = np.array([58.104, -23.326, 5.657])
...
right_jury_le_left = np.array([57.537, 23.326, 0.618])
right_jury_le_right = np.array([56.919, 23.326, 5.657])
right_jury_te_left = np.array([58.493, 23.326, 0.618])
right_jury_te_right = np.array([58.104, 23.326, 5.657])
...
if FFD_working_old_5: 
    ...
    # left -ve y
    wing_left_strut_connection_point = np.array([61.213, -43.611, 5.785])
    ...
    wing_right_strut_connection_point = np.array([61.213, 43.611, 5.785])
    ...
    # left
    wing_left_jury_connection_point = np.array([58.484, -28.080, 5.657])
    ...
    # right 
    wing_right_jury_connection_point = np.array([58.484, 28.080, 5.657])
    ...
    # left
    left_jury_left_strut_connection_point = np.array([58.990, -28.080, 0.618])
    ...
    #right
    right_jury_right_strut_connection_point = np.array([58.990, 28.080, 0.618])
...
if FFD_working_old_6: 
    ...
    # wing and strut connection
    # left -ve y
    wing_left_strut_connection_point = np.array([59.887, -34.029, 0.618])
    wing_projection_on_left_strut = wing.project(wing_left_strut_connection_point)
    left_strut_projection_on_wing = strut_left.project(wing_left_strut_connection_point)
    #right +ve y
    # wing_right_strut_connection_point = np.array([61.661, 48.994, 5.927])
    wing_right_strut_connection_point = np.array([59.887, 34.029, 0.618])
    wing_projection_on_right_strut = wing.project(wing_right_strut_connection_point)
    right_strut_projection_on_wing = strut_right.project(wing_right_strut_connection_point)

    #jury and wing connection
    # left
    wing_left_jury_connection_point = np.array([57.5, -23.326, 5.657])
    wing_projection_on_left_jury = wing.project(wing_left_jury_connection_point)
    left_jury_projection_on_wing = jury_left.project(wing_left_jury_connection_point)
    # right 
    wing_right_jury_connection_point = np.array([57.5, 23.326, 5.657])
    wing_projection_on_right_jury = wing.project(wing_right_jury_connection_point)
    right_jury_projection_on_wing = jury_right.project(wing_right_jury_connection_point)

    # jury and strut connection
    # left
    left_jury_left_strut_connection_point = np.array([58.006, -23.326, 0.618])
    left_jury_projection_on_left_strut = jury_left.project(left_jury_left_strut_connection_point)
    left_strut_projection_on_left_jury = strut_left.project(left_jury_left_strut_connection_point)
    #right
    right_jury_right_strut_connection_point = np.array([58.006, 23.326, 0.618])
    right_jury_projection_on_right_strut = jury_right.project(right_jury_right_strut_connection_point)
    right_strut_projection_on_right_jury = strut_right.project(right_jury_right_strut_connection_point)
...
#     wing_fuselage_connection_input = system_model.create_input(name='wing_fuselage_connection', shape=(3, ), val=wing_fuselage_connection_m3l.value)
    ...
    wing_sweep_angle = system_model.create_input(name='wing_sweep_angle', shape=(1,), val=np.deg2rad(23.35), dv_flag = geometry_dv, 
    ...
    left_strut_sweep_coefficients[np.array([0])] = (-1/2.5) * wing_sweep_coefficients[np.array([0])]
    ...
    right_strut_sweep_coefficients[np.array([1])] = (-1/2.5) *  wing_sweep_coefficients[np.array([2])]
