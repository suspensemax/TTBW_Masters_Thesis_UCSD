...
vertex01_left_strut = np.array([54.957, -45.739, -3.216]) # left leading 2
vertex02_left_strut = np.array([56.155, -23.483, -0.756]) # left leading 3
vertex03_left_strut = np.array([57.930, -28.129, 0.719]) # left leading 4
vertex04_left_strut = np.array([57.591, -32.775, 2.195]) # left leading 5
vertex05_left_strut = np.array([58.789, -40.519, 4.655]) # left leading 6
vertex06_left_strut = np.array([60.324, -43.616, 5.639]) # left leading 7

vertex10_left_strut = np.array([57.309, -12.641, -4.200]) # left trailing 1
vertex11_left_strut = np.array([58.883, -15.739, -3.216]) # left trailing 2
vertex12_left_strut = np.array([60.080, -23.483, -0.756]) # left trailing 3
vertex13_left_strut = np.array([59.742, -28.129, 0.719]) # left trailing 4
vertex14_left_strut = np.array([61.517, -32.775, 2.195]) # left trailing 5
vertex15_left_strut = np.array([62.714, -40.519, 4.655]) # left trailing 6                
vertex16_left_strut = np.array([62.136, -43.616, 5.639]) # left trailing 7
...
vertex01_right_strut = np.array([54.957, 45.739, -3.216]) # right leading 2
vertex02_right_strut = np.array([56.155, 23.483, -0.756]) # right leading 3
vertex03_right_strut = np.array([57.930, 28.129, 0.719]) # right leading 4
vertex04_right_strut = np.array([57.591, 32.775, 2.195]) # right leading 5
vertex05_right_strut = np.array([58.789, 40.519, 4.655]) # right leading 6
vertex06_right_strut = np.array([60.324, 43.616, 5.639]) # right leading 7

vertex10_right_strut = np.array([57.309, 12.641, -4.200]) # right trailing 1
vertex11_right_strut = np.array([58.883, 15.739, -3.216]) # right trailing 2
vertex12_right_strut = np.array([60.080, 23.483, -0.756]) # right trailing 3
vertex13_right_strut = np.array([59.742, 28.129, 0.719]) # right trailing 4
vertex14_right_strut = np.array([61.517, 32.775, 2.195]) # right trailing 5
vertex15_right_strut = np.array([62.714, 40.519, 4.655]) # right trailing 6                
vertex16_right_strut = np.array([62.136, 43.616, 5.639]) # right trailing 7
...
left_jury_le_left = np.array([58.521, -28.080, 0.618])
left_jury_le_right = np.array([57.902, -28.080, 5.657])
left_jury_te_left = np.array([59.477, -28.080, 0.618])
left_jury_te_right = np.array([59.087, -28.080, 5.657])
...
right_jury_le_left = np.array([58.521, 28.080, 0.618])
right_jury_le_right = np.array([57.902,28.080, 5.657])
right_jury_te_left = np.array([59.477, 28.080, 0.618])
right_jury_te_right = np.array([59.087,28.080, 5.657])
