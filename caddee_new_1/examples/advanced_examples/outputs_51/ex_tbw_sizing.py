...
from examples.advanced_examples.outputs_51.tbw_geometry_sizing import (wing_meshes, htail_meshes, wing_span_dv, wing_root_chord_dv, 
                                                                        wing_mid_chord_left_dv, wing_tip_chord_left_dv,   
                                                                left_strut_meshes, right_strut_meshes, 
                                                                left_jury_meshes, right_jury_meshes, 
                                                                vtail_meshes, S_ref_area, system_model, wing_AR, 
...
#     counter = 'original_SLSPQ'
    counter = 1
    sim = Simulator(caddee_csdl_model,name = 'just_sizing_outputs_outputs_51', analytics=True)
    ...
    prob = CSDLProblem(problem_name='just_sizing_outputs_outputs_51_optimization', simulator=sim)
