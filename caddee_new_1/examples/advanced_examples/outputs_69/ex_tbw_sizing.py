...
from examples.advanced_examples.outputs_69.tbw_geometry_sizing import (wing_meshes, htail_meshes, wing_span_dv, wing_root_chord_dv, 
...
if sizing_full:
    ...
    counter = '69_SLSPQ'
    sim = Simulator(caddee_csdl_model,name = f'just_sizing_outputs_{counter}', analytics=True)
    ...
    prob = CSDLProblem(problem_name=f'just_sizing_outputs_{counter}_optimization', simulator=sim)
