...
class tbwconstranaly_outputs:
    ...
    constraint_v_stall: m3l.Variable
...
class TBW_Constraints_Analysis_Model(m3l.ExplicitOperation):
    ...
    def evaluate(self, atmos: AtmosphericProperties, 
        ...
        constraint_v_stall = m3l.Variable(name='constraint_v_stall', shape=(num_nodes, 1), operation=self)
        ...
        outputs = tbwconstranaly_outputs(
            ...
            constraint_v_stall = constraint_v_stall,
        )
        return outputs
...
class TBW_Constraints_Analysis_Model_CSDL(ModuleCSDL):
    ...
    def define(self):
        ...
        constraint_v_stall = V_Me - Vstall
        ...
        self.register_output('V_Me',V_Me)
        self.register_output('Vstall',Vstall)
        ...
        self.register_output('constraint_v_stall', constraint_v_stall)
